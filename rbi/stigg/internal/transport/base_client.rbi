    ...
    module Transport
      ...
      class BaseClient
        ...
        class << self
          ...
          sig do
            params(
              request: Stigg::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
              response_headers: T::Hash[String, String]
            ).returns(Stigg::Internal::Transport::BaseClient::RequestInput)
          end
          ...
          sig do
            params(
              status: T.any(Integer, Stigg::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(Stigg::Internal::Transport::PooledNetRequester) }
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: Stigg::Internal::Type::Unknown,
          options: {}
        )
        end
