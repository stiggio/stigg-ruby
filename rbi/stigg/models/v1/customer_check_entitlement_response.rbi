    ...
    module V1
      class CustomerCheckEntitlementResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1::CustomerCheckEntitlementResponse,
        ...
        sig do
          returns(
            Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Variants
          )
        end
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T.any(
                Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::OrHash,
                Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::OrHash
              )
        ...
        module Data
          ...
          Variants =
            T.type_alias do
              T.any(
                Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature,
                Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit
              )
            end
          ...
          class Feature < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::AccessDeniedReason::TaggedSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature
                )
              )
            end
            attr_reader :feature
            ...
            sig do
              params(
                feature:
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::OrHash
              ).void
            end
            attr_writer :feature
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::ResetPeriod::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                access_denied_reason:
                  T.nilable(
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::AccessDeniedReason::OrSymbol
                  ),
                ...
                reset_period:
                  T.nilable(
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::ResetPeriod::OrSymbol
                  ),
            ...
            module AccessDeniedReason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::AccessDeniedReason
                  )
                end
            ...
            class Feature < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::FeatureStatus::TaggedSymbol
                )
              end
              ...
              sig do
                returns(
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::FeatureType::TaggedSymbol
                )
              end
              ...
              sig do
                params(
                  ...
                  display_name: String,
                  feature_status:
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::FeatureStatus::OrSymbol,
                  feature_type:
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::FeatureType::OrSymbol
                ).returns(T.attached_class)
              end
              def self.new(
                # The unique reference ID of the entitlement.
              ...
              module FeatureStatus
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::FeatureStatus
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              module FeatureType
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::Feature::FeatureType
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module ResetPeriod
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Feature::ResetPeriod
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Credit < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::AccessDeniedReason::TaggedSymbol
                )
              )
            end
            attr_accessor :access_denied_reason
            ...
            sig do
              returns(
                Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::Currency
              )
            end
            ...
            sig do
              params(
                currency:
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::Currency::OrHash
              ).void
            end
            ...
            sig do
              params(
                access_denied_reason:
                  T.nilable(
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::AccessDeniedReason::OrSymbol
                  ),
                currency:
                  Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::Currency::OrHash,
                current_usage: Float,
            ...
            module AccessDeniedReason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::CustomerCheckEntitlementResponse::Data::Credit::AccessDeniedReason
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
