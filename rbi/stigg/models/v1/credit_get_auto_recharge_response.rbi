    ...
    module V1
      class CreditGetAutoRechargeResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1::CreditGetAutoRechargeResponse,
              Stigg::Internal::AnyHash
            )
          end

        # Automatic recharge configuration for a customer and currency
        sig { returns(Stigg::Models::V1::CreditGetAutoRechargeResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            { data: Stigg::Models::V1::CreditGetAutoRechargeResponse::Data }
          )
        end
        def to_hash
        end
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1::CreditGetAutoRechargeResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::GrantExpirationPeriod::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::ThresholdType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              grant_expiration_period:
                Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::GrantExpirationPeriod::OrSymbol,
              is_enabled: T::Boolean,
              max_spend_limit: T.nilable(Float),
              target_balance: Float,
              threshold_type:
                Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::ThresholdType::OrSymbol,
          ...
          module GrantExpirationPeriod
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::GrantExpirationPeriod
                )
              end
          ...
          module ThresholdType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::CreditGetAutoRechargeResponse::Data::ThresholdType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
