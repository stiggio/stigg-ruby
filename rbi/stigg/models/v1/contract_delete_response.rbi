    ...
    module V1
      class ContractDeleteResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1::ContractDeleteResponse,
              Stigg::Internal::AnyHash
            )
          end

        # A billing contract as reported by the connected billing provider.
        sig { returns(Stigg::Models::V1::ContractDeleteResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1::ContractDeleteResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1::ContractDeleteResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              latest_invoice:
                T.nilable(
                  Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              next_invoice:
                T.nilable(
                  Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              Stigg::Models::V1::ContractDeleteResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            returns(
              T::Array[
                Stigg::Models::V1::ContractDeleteResponse::Data::Subscription
              ]
            )
          end
          ...
          sig do
            params(
              ...
              state:
                Stigg::Models::V1::ContractDeleteResponse::Data::State::OrSymbol,
              subscriptions:
                T::Array[
                  Stigg::Models::V1::ContractDeleteResponse::Data::Subscription::OrHash
                ]
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::Status::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::BillingReason::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                ...
                status:
                  Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::Status::OrSymbol,
                amount_due: T.nilable(Float),
                billing_reason:
                  T.nilable(
                    Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::BillingReason::OrSymbol
                  ),
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module BillingReason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::BillingReason
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class NextInvoice < Stigg::Internal::Type::BaseModel
            ...
            class Amount < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount::Currency::TaggedSymbol
                )
              end
              attr_accessor :currency
              ...
              sig do
                params(
                  amount: Float,
                  currency:
                    Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount::Currency::OrSymbol
                ).returns(T.attached_class)
              end
              def self.new(
                # The price amount
              ...
              module Currency
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount::Currency
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::ContractDeleteResponse::Data::State
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
