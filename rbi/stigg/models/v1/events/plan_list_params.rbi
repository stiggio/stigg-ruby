...
module Stigg
  module Models
    module V1
      module Events
        class PlanListParams < Stigg::Internal::Type::BaseModel
          extend Stigg::Internal::Type::RequestParameters::Converter
          include Stigg::Internal::Type::RequestParameters

          OrHash =
            T.type_alias do
              T.any(Stigg::V1::Events::PlanListParams, Stigg::Internal::AnyHash)
            end
          ...
          sig do
            returns(T.nilable(Stigg::V1::Events::PlanListParams::CreatedAt))
          end
            ...
            override.returns(
              {
                after: String,
                before: String,
                created_at: Stigg::V1::Events::PlanListParams::CreatedAt,
                limit: Integer,
                product_id: String,
                status: String,
          ...
          class CreatedAt < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::Events::PlanListParams::CreatedAt,
