      ...
      module Events
        module DataExport
          class DestinationCreateResponse < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::Events::DataExport::DestinationCreateResponse::Data
              )
            end
            attr_reader :data
            ...
            sig do
              params(
                data:
                  Stigg::Models::V1::Events::DataExport::DestinationCreateResponse::Data::OrHash
              ).void
            end
            attr_writer :data
            ...
            class Data < Stigg::Internal::Type::BaseModel
              ...
              sig do
                params(
                  destinations:
                    T::Array[
                      Stigg::Models::V1::Events::DataExport::DestinationCreateResponse::Data::Destination::OrHash
                    ]
                ).returns(T.attached_class)
              end
              def self.new(
