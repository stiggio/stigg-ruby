      ...
      module Events
        module Credits
          class CustomCurrencyArchiveResponse < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::Events::Credits::CustomCurrencyArchiveResponse::Data
              )
            end
            attr_reader :data
            ...
            sig do
              params(
                data:
                  Stigg::Models::V1::Events::Credits::CustomCurrencyArchiveResponse::Data::OrHash
              ).void
            end
            attr_writer :data
            ...
            class Data < Stigg::Internal::Type::BaseModel
              ...
              sig do
                params(
                  units:
                    T.nilable(
                      Stigg::Models::V1::Events::Credits::CustomCurrencyArchiveResponse::Data::Units::OrHash
                    )
                ).void
              end
              attr_writer :units
