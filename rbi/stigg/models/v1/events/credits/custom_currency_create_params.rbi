        ...
        module Credits
          class CustomCurrencyCreateParams < Stigg::Internal::Type::BaseModel
            ...
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::Events::Credits::CustomCurrencyCreateParams,
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::V1::Events::Credits::CustomCurrencyCreateParams::Units
                )
              )
            end
            attr_reader :units
            ...
            class Units < Stigg::Internal::Type::BaseModel
              ...
              # when supplied.
              sig do
                params(plural: String, singular: String).returns(
                  T.attached_class
                )
              end
              def self.new(
