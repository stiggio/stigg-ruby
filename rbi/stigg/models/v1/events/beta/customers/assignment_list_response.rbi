        ...
        module Beta
          module Customers
            class AssignmentListResponse < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::Models::V1::Events::Beta::Customers::AssignmentListResponse::Cadence::TaggedSymbol
                )
              end
              ...
              sig do
                params(
                  id: String,
                  cadence:
                    Stigg::Models::V1::Events::Beta::Customers::AssignmentListResponse::Cadence::OrSymbol,
              ...
              module Cadence
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::Events::Beta::Customers::AssignmentListResponse::Cadence
                    )
                  end
