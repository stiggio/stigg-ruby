          ...
          module Customers
            class AssignmentUpsertParams < Stigg::Internal::Type::BaseModel
              ...
              OrHash =
                T.type_alias do
                  T.any(
                    Stigg::V1::Events::Beta::Customers::AssignmentUpsertParams,
              ...
              sig do
                returns(
                  T::Array[
                    Stigg::V1::Events::Beta::Customers::AssignmentUpsertParams::Assignment
                  ]
                )
              end
              ...
              class Assignment < Stigg::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    T.nilable(
                      Stigg::V1::Events::Beta::Customers::AssignmentUpsertParams::Assignment::Cadence::OrSymbol
                    )
                  )
                end
                attr_reader :cadence
                ...
                module Cadence
                  ...
                  TaggedSymbol =
                    T.type_alias do
                      T.all(
                        Symbol,
                        Stigg::V1::Events::Beta::Customers::AssignmentUpsertParams::Assignment::Cadence
                      )
                    end
                  ...
                  MONTH =
                    T.let(
                      :MONTH,
                      Stigg::V1::Events::Beta::Customers::AssignmentUpsertParams::Assignment::Cadence::TaggedSymbol
                    )
