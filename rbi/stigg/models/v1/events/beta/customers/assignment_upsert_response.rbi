          ...
          module Customers
            class AssignmentUpsertResponse < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data
                  ]
                )
              end
              attr_accessor :data
              ...
              sig do
                params(
                  data:
                    T::Array[
                      Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::OrHash
                    ]
              ...
              class Data < Stigg::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::Cadence::TaggedSymbol
                  )
                end
                ...
                sig do
                  params(
                    id: String,
                    cadence:
                      Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::Cadence::OrSymbol,
                ...
                module Cadence
                  ...
                  TaggedSymbol =
                    T.type_alias do
                      T.all(
                        Symbol,
                        Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::Cadence
                      )
                    end
