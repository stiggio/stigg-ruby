        ...
        class PlanRetrieveResponse < Stigg::Internal::Type::BaseModel
          ...
          class Data < Stigg::Internal::Type::BaseModel
            ...
            sig do
              params(
                default_trial_config:
                  T.nilable(
                    Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::OrHash
                  )
              ).void
            end
            ...
            class DefaultTrialConfig < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::Units::TaggedSymbol
                )
              end
              attr_accessor :units
              ...
              sig do
                params(
                  budget:
                    T.nilable(
                      Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::Budget::OrHash
                    )
                ).void
              end
              attr_writer :budget
              ...
              sig do
                returns(
                  T.nilable(
                    Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::TrialEndBehavior::TaggedSymbol
                  )
                )
              end
              ...
              sig do
                params(
                  duration: Float,
                  units:
                    Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::Units::OrSymbol,
                  budget:
                    T.nilable(
                      Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::Budget::OrHash
                    ),
                  trial_end_behavior:
                    T.nilable(
                      Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::TrialEndBehavior::OrSymbol
                    )
                ).returns(T.attached_class)
              end
              def self.new(
              ...
              module Units
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::Units
                    )
                  end
              ...
              module TrialEndBehavior
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::Events::PlanRetrieveResponse::Data::DefaultTrialConfig::TrialEndBehavior
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
