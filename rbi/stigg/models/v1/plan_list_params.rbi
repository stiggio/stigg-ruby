  ...
  module Models
    module V1
      class PlanListParams < Stigg::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(Stigg::V1::PlanListParams, Stigg::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Stigg::V1::PlanListParams::CreatedAt)) }
        attr_reader :created_at

        sig do
          params(created_at: Stigg::V1::PlanListParams::CreatedAt::OrHash).void
        end
        ...
        class CreatedAt < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::PlanListParams::CreatedAt,
