    ...
    module V1
      class ContractUpdateResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1::ContractUpdateResponse,
              Stigg::Internal::AnyHash
            )
          end

        # A billing contract as reported by the connected billing provider.
        sig { returns(Stigg::Models::V1::ContractUpdateResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1::ContractUpdateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1::ContractUpdateResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Stigg::Models::V1::ContractUpdateResponse::Data::BillingState::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              latest_invoice:
                T.nilable(
                  Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              next_invoice:
                T.nilable(
                  Stigg::Models::V1::ContractUpdateResponse::Data::NextInvoice::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              Stigg::Models::V1::ContractUpdateResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            returns(
              T::Array[
                Stigg::Models::V1::ContractUpdateResponse::Data::Subscription
              ]
            )
          end
          ...
          sig do
            params(
              ...
              billing_state:
                T.nilable(
                  Stigg::Models::V1::ContractUpdateResponse::Data::BillingState::OrSymbol
                ),
              contract_id: String,
              ...
              state:
                Stigg::Models::V1::ContractUpdateResponse::Data::State::OrSymbol,
              subscriptions:
                T::Array[
                  Stigg::Models::V1::ContractUpdateResponse::Data::Subscription::OrHash
                ]
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module BillingState
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::ContractUpdateResponse::Data::BillingState
                )
              end
          ...
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::Status::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::BillingReason::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                ...
                status:
                  Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::Status::OrSymbol,
                amount_due: T.nilable(Float),
                billing_reason:
                  T.nilable(
                    Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::BillingReason::OrSymbol
                  ),
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module BillingReason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::ContractUpdateResponse::Data::LatestInvoice::BillingReason
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class NextInvoice < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::ContractUpdateResponse::Data::NextInvoice::Amount
              )
            end
            attr_reader :amount
            ...
            sig do
              params(
                amount:
                  Stigg::Models::V1::ContractUpdateResponse::Data::NextInvoice::Amount::OrHash
              ).void
            end
            attr_writer :amount
            ...
            class Amount < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::Models::V1::ContractUpdateResponse::Data::NextInvoice::Amount::Currency::TaggedSymbol
                )
              end
              attr_accessor :currency
              ...
              sig do
                params(
                  amount: Float,
                  currency:
                    Stigg::Models::V1::ContractUpdateResponse::Data::NextInvoice::Amount::Currency::OrSymbol
                ).returns(T.attached_class)
              end
              def self.new(
                # The price amount
              ...
              module Currency
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::Models::V1::ContractUpdateResponse::Data::NextInvoice::Amount::Currency
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::ContractUpdateResponse::Data::State
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
