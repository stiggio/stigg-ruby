    ...
    module V1
      module Credits
        class AutoRechargeGetAutoRechargeResponse < Stigg::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Data < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::GrantExpirationPeriod::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::ThresholdType::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                ...
                grant_expiration_period:
                  Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::GrantExpirationPeriod::OrSymbol,
                is_enabled: T::Boolean,
                max_spend_limit: T.nilable(Float),
                target_balance: Float,
                threshold_type:
                  Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::ThresholdType::OrSymbol,
            ...
            module GrantExpirationPeriod
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::GrantExpirationPeriod
                  )
                end
            ...
            module ThresholdType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::Credits::AutoRechargeGetAutoRechargeResponse::Data::ThresholdType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
