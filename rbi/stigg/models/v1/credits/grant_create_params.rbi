      ...
      module Credits
        class GrantCreateParams < Stigg::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::Credits::GrantCreateParams,
          ...
          sig do
            returns(Stigg::V1::Credits::GrantCreateParams::GrantType::OrSymbol)
          end
          ...
          sig do
            returns(T.nilable(Stigg::V1::Credits::GrantCreateParams::Cost))
          end
          attr_reader :cost
            ...
            override.returns(
              {
                ...
                billing_information:
                  Stigg::V1::Credits::GrantCreateParams::BillingInformation,
                comment: String,
                cost: Stigg::V1::Credits::GrantCreateParams::Cost,
                effective_at: Time,
                expire_at: Time,
                metadata: T::Hash[Symbol, String],
                payment_collection_method:
          ...
          module GrantType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, Stigg::V1::Credits::GrantCreateParams::GrantType)
              end
            ...
            PAID =
              T.let(
                :PAID,
                Stigg::V1::Credits::GrantCreateParams::GrantType::TaggedSymbol
              )
            PROMOTIONAL =
              T.let(
                :PROMOTIONAL,
          ...
          class BillingInformation < Stigg::Internal::Type::BaseModel
            ...
            sig do
              params(
                billing_address:
                  Stigg::V1::Credits::GrantCreateParams::BillingInformation::BillingAddress::OrHash
              ).void
            end
          ...
          class Cost < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::Credits::GrantCreateParams::Cost,
                  Stigg::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                Stigg::V1::Credits::GrantCreateParams::Cost::Currency::OrSymbol
              )
            end
            ...
            module Currency
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::Credits::GrantCreateParams::Cost::Currency
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              USD =
                T.let(
                  :usd,
                  Stigg::V1::Credits::GrantCreateParams::Cost::Currency::TaggedSymbol
                )
              AED =
                T.let(
                  :aed,
          ...
          module PaymentCollectionMethod
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::V1::Credits::GrantCreateParams::PaymentCollectionMethod
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            CHARGE =
              T.let(
                :CHARGE,
                Stigg::V1::Credits::GrantCreateParams::PaymentCollectionMethod::TaggedSymbol
              )
            INVOICE =
              T.let(
                :INVOICE,
