      ...
      module Credits
        class CreditGrantResponse < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::Credits::CreditGrantResponse,
          ...
          sig do
            params(
              data: Stigg::V1::Credits::CreditGrantResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          sig do
            override.returns(
              { data: Stigg::V1::Credits::CreditGrantResponse::Data }
            )
          end
          def to_hash
          end
          ...
          class Data < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::Credits::CreditGrantResponse::Data,
                  Stigg::Internal::AnyHash
                )
              end
            ...
            sig { returns(Stigg::V1::Credits::CreditGrantResponse::Data::Cost) }
            attr_reader :cost

            sig do
              params(
                cost:
                  Stigg::V1::Credits::CreditGrantResponse::Data::Cost::OrHash
              ).void
            end
            attr_writer :cost
            ...
            sig do
              returns(
                Stigg::V1::Credits::CreditGrantResponse::Data::GrantType::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                latest_invoice:
                  T.nilable(
                    Stigg::V1::Credits::CreditGrantResponse::Data::LatestInvoice::OrHash
                  )
              ).void
            end
            ...
            sig do
              returns(
                Stigg::V1::Credits::CreditGrantResponse::Data::PaymentCollection::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::V1::Credits::CreditGrantResponse::Data::SourceType::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                ...
                grant_type:
                  Stigg::V1::Credits::CreditGrantResponse::Data::GrantType::OrSymbol,
                ...
                payment_collection:
                  Stigg::V1::Credits::CreditGrantResponse::Data::PaymentCollection::OrSymbol,
                priority: Float,
                resource_id: T.nilable(String),
                source_type:
                  T.nilable(
                    Stigg::V1::Credits::CreditGrantResponse::Data::SourceType::OrSymbol
                  ),
                status:
              ...
              override.returns(
                {
                  ...
                  comment: T.nilable(String),
                  consumed_amount: Float,
                  cost: Stigg::V1::Credits::CreditGrantResponse::Data::Cost,
                  created_at: Time,
                  currency_id: String,
                  customer_id: String,
                  display_name: String,
            ...
            class Cost < Stigg::Internal::Type::BaseModel
              OrHash =
                T.type_alias do
                  T.any(
                    Stigg::V1::Credits::CreditGrantResponse::Data::Cost,
                    Stigg::Internal::AnyHash
                  )
                end
            ...
            module GrantType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::Credits::CreditGrantResponse::Data::GrantType
                  )
                end
            ...
            class LatestInvoice < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Stigg::V1::Credits::CreditGrantResponse::Data::LatestInvoice::BillingReason::TaggedSymbol
                  )
                )
              end
              ...
              sig do
                returns(
                  Stigg::V1::Credits::CreditGrantResponse::Data::LatestInvoice::Status::TaggedSymbol
                )
              end
              attr_accessor :status
              ...
              sig do
                params(
                  ...
                  billing_reason:
                    T.nilable(
                      Stigg::V1::Credits::CreditGrantResponse::Data::LatestInvoice::BillingReason::OrSymbol
                    ),
                  created_at: Time,
                  ...
                  status:
                    Stigg::V1::Credits::CreditGrantResponse::Data::LatestInvoice::Status::OrSymbol,
              ...
              module Status
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::V1::Credits::CreditGrantResponse::Data::LatestInvoice::Status
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module PaymentCollection
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::Credits::CreditGrantResponse::Data::PaymentCollection
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module SourceType
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::Credits::CreditGrantResponse::Data::SourceType
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::Credits::CreditGrantResponse::Data::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
