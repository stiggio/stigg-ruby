      ...
      module Credits
        class GrantListParams < Stigg::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::Credits::GrantListParams,
          ...
          sig do
            returns(T.nilable(Stigg::V1::Credits::GrantListParams::CreatedAt))
          end
          attr_reader :created_at

          sig do
            params(
              created_at: Stigg::V1::Credits::GrantListParams::CreatedAt::OrHash
            ).void
          end
            ...
            override.returns(
              {
                ...
                after: String,
                before: String,
                created_at: Stigg::V1::Credits::GrantListParams::CreatedAt,
                currency_id: String,
                limit: Integer,
                resource_id: String,
          ...
          class CreatedAt < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::Credits::GrantListParams::CreatedAt,
                  Stigg::Internal::AnyHash
                )
              end
