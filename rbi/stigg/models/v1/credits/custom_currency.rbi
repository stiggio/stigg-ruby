      ...
      module Credits
        class CustomCurrency < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::Credits::CustomCurrency,
                Stigg::Internal::AnyHash
              )
            end

          # A custom currency used to denominate credit-based entitlements and pricing
          sig { returns(Stigg::V1::Credits::CustomCurrency::Data) }
          attr_reader :data

          sig do
            params(data: Stigg::V1::Credits::CustomCurrency::Data::OrHash).void
          end
          attr_writer :data
          ...
          sig do
            params(
              data: Stigg::V1::Credits::CustomCurrency::Data::OrHash
          ...
          sig do
            override.returns({ data: Stigg::V1::Credits::CustomCurrency::Data })
          end
          def to_hash
          end
          ...
          class Data < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::Credits::CustomCurrency::Data,
                  Stigg::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T.nilable(Stigg::V1::Credits::CustomCurrency::Data::Units)
              )
            end
            attr_reader :units
            ...
            sig do
              params(
                units:
                  T.nilable(
                    Stigg::V1::Credits::CustomCurrency::Data::Units::OrHash
                  )
              ).void
            end
            attr_writer :units
            ...
            class Units < Stigg::Internal::Type::BaseModel
              OrHash =
                T.type_alias do
                  T.any(
                    Stigg::V1::Credits::CustomCurrency::Data::Units,
                    Stigg::Internal::AnyHash
                  )
                end
