    ...
    module V1
      module Credits
        class GrantListResponse < Stigg::Internal::Type::BaseModel
          ...
          sig { returns(Stigg::Models::V1::Credits::GrantListResponse::Cost) }
          attr_reader :cost

          sig do
            params(
              cost: Stigg::Models::V1::Credits::GrantListResponse::Cost::OrHash
            ).void
          end
          attr_writer :cost
          ...
          sig do
            params(
              latest_invoice:
                T.nilable(
                  Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              Stigg::Models::V1::Credits::GrantListResponse::PaymentCollection::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Stigg::Models::V1::Credits::GrantListResponse::SourceType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              grant_type:
                Stigg::Models::V1::Credits::GrantListResponse::GrantType::OrSymbol,
              ...
              payment_collection:
                Stigg::Models::V1::Credits::GrantListResponse::PaymentCollection::OrSymbol,
              priority: Float,
              resource_id: T.nilable(String),
              source_type:
                T.nilable(
                  Stigg::Models::V1::Credits::GrantListResponse::SourceType::OrSymbol
                ),
              status:
            ...
            override.returns(
              {
                ...
                comment: T.nilable(String),
                consumed_amount: Float,
                cost: Stigg::Models::V1::Credits::GrantListResponse::Cost,
                created_at: Time,
                currency_id: String,
                customer_id: String,
                display_name: String,
          ...
          class Cost < Stigg::Internal::Type::BaseModel
            ...
            # The monetary cost of the credit grant
            sig do
              params(amount: Float, currency: String).returns(T.attached_class)
            end
            def self.new(
              # The cost amount
              amount:,
          ...
          module GrantType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::Credits::GrantListResponse::GrantType
                )
              end
          ...
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::BillingReason::TaggedSymbol
                )
              )
            end
            ...
            sig do
              returns(
                Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::Status::TaggedSymbol
              )
            end
            attr_accessor :status
            ...
            sig do
              params(
                ...
                billing_reason:
                  T.nilable(
                    Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::BillingReason::OrSymbol
                  ),
                created_at: Time,
                ...
                status:
                  Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::Status::OrSymbol,
            ...
            module BillingReason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::BillingReason
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module PaymentCollection
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::Credits::GrantListResponse::PaymentCollection
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module SourceType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::Credits::GrantListResponse::SourceType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::Credits::GrantListResponse::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
