      ...
      module Plans
        class EntitlementCreateParams < Stigg::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::Plans::EntitlementCreateParams,
            ...
            class Feature < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::HiddenFromWidget::OrSymbol
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  monthly_reset_period_configuration:
                    T.nilable(
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration::OrHash
                    )
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::ResetPeriod::OrSymbol
                  )
                )
              end
              ...
              sig do
                params(
                  weekly_reset_period_configuration:
                    T.nilable(
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration::OrHash
                    )
                ).void
              end
              ...
              module Behavior
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::Behavior
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                INCREMENT =
                  T.let(
                    :Increment,
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::Behavior::TaggedSymbol
                  )
                OVERRIDE =
                  T.let(
                    :Override,
              ...
              module HiddenFromWidget
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::HiddenFromWidget
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                PAYWALL =
                  T.let(
                    :PAYWALL,
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::HiddenFromWidget::TaggedSymbol
                  )
                CUSTOMER_PORTAL =
                  T.let(
                    :CUSTOMER_PORTAL,
              ...
              class MonthlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration::AccordingTo::OrSymbol
                  )
                end
                ...
                module AccordingTo
                  ...
                  SUBSCRIPTION_START =
                    T.let(
                      :SubscriptionStart,
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration::AccordingTo::TaggedSymbol
                    )
                  START_OF_THE_MONTH =
                    T.let(
                      :StartOfTheMonth,
              ...
              module ResetPeriod
                ...
                YEAR =
                  T.let(
                    :YEAR,
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::ResetPeriod::TaggedSymbol
                  )
                MONTH =
                  T.let(
                    :MONTH,
              ...
              class WeeklyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration::AccordingTo::OrSymbol
                  )
                end
                attr_accessor :according_to
                ...
                module AccordingTo
                  ...
                  SUBSCRIPTION_START =
                    T.let(
                      :SubscriptionStart,
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration::AccordingTo::TaggedSymbol
                    )
                  EVERY_SUNDAY =
                    T.let(
                      :EverySunday,
              ...
              class YearlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::YearlyResetPeriodConfiguration::AccordingTo::OrSymbol
                  )
                end
                attr_accessor :according_to
                ...
                module AccordingTo
                  ...
                  SUBSCRIPTION_START =
                    T.let(
                      :SubscriptionStart,
                      Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature::YearlyResetPeriodConfiguration::AccordingTo::TaggedSymbol
                    )
