    ...
    module V1
      class PlanPublishResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1::PlanPublishResponse,
              Stigg::Internal::AnyHash
            )
          end

        sig { returns(Stigg::Models::V1::PlanPublishResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1::PlanPublishResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1::PlanPublishResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
