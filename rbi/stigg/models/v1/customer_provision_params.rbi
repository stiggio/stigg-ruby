  ...
  module Models
    module V1
      class CustomerProvisionParams < Stigg::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Stigg::V1::CustomerProvisionParams::Passthrough))
        end
        attr_reader :passthrough

        sig do
          params(
            passthrough: Stigg::V1::CustomerProvisionParams::Passthrough::OrHash
          ).void
        end
          ...
          override.returns(
            {
              ...
              metadata: T::Hash[Symbol, String],
              name: T.nilable(String),
              passthrough: Stigg::V1::CustomerProvisionParams::Passthrough,
              timezone: T.nilable(String),
        ...
        module CouponID
          ...
          Variants =
            T.type_alias do
              T.any(
                String,
                Stigg::V1::CustomerProvisionParams::CouponID::TaggedSymbol
              )
            end

          sig do
            override.returns(
              T::Array[Stigg::V1::CustomerProvisionParams::CouponID::Variants]
            )
          end
          def self.variants
          end
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Stigg::V1::CustomerProvisionParams::CouponID)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Passthrough < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::CustomerProvisionParams::Passthrough,
                Stigg::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(Stigg::V1::CustomerProvisionParams::Passthrough::Stripe)
            )
          end
          attr_reader :stripe
          ...
          sig do
            params(
              stripe:
                Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::OrHash
            ).void
          end
          attr_writer :stripe
          ...
          sig do
            returns(
              T.nilable(Stigg::V1::CustomerProvisionParams::Passthrough::Zuora)
            )
          end
          attr_reader :zuora
          ...
          sig do
            params(
              zuora:
                Stigg::V1::CustomerProvisionParams::Passthrough::Zuora::OrHash
            ).void
          end
          attr_writer :zuora
          ...
          sig do
            override.returns(
              {
                stripe: Stigg::V1::CustomerProvisionParams::Passthrough::Stripe,
                zuora: Stigg::V1::CustomerProvisionParams::Passthrough::Zuora
              }
            )
          end
          def to_hash
          ...
          class Stripe < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::CustomerProvisionParams::Passthrough::Stripe,
                  Stigg::Internal::AnyHash
                )
              end
            ...
            sig do
              params(
                billing_address:
                  Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::BillingAddress::OrHash
              ).void
            end
            ...
            sig do
              params(
                shipping_address:
                  Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::ShippingAddress::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::TaxID
                  ]
                )
              )
            end
            ...
            sig do
              params(
                tax_ids:
                  T::Array[
                    Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::TaxID::OrHash
                  ]
              ).void
            end
            attr_writer :tax_ids
          ...
          class Zuora < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::CustomerProvisionParams::Passthrough::Zuora,
                  Stigg::Internal::AnyHash
                )
              end
            ...
            sig do
              params(
                billing_address:
                  Stigg::V1::CustomerProvisionParams::Passthrough::Zuora::BillingAddress::OrHash
              ).void
            end
            attr_writer :billing_address
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::V1::CustomerProvisionParams::Passthrough::Zuora::Currency::OrSymbol
                )
              )
            end
            ...
            module Currency
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::CustomerProvisionParams::Passthrough::Zuora::Currency
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              USD =
                T.let(
                  :usd,
                  Stigg::V1::CustomerProvisionParams::Passthrough::Zuora::Currency::TaggedSymbol
                )
              AED =
                T.let(
                  :aed,
