    ...
    module V1
      class FeatureUpdateFeatureParams < Stigg::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Stigg::V1::FeatureUpdateFeatureParams,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Stigg::V1::FeatureUpdateFeatureParams::EnumConfiguration]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(Stigg::V1::FeatureUpdateFeatureParams::UnitTransformation)
          )
        end
          ...
          override.returns(
            {
              ...
              enum_configuration:
                T::Array[
                  Stigg::V1::FeatureUpdateFeatureParams::EnumConfiguration
                ],
              feature_units: String,
              feature_units_plural: String,
              metadata: T::Hash[Symbol, String],
              meter: Stigg::V1::FeatureUpdateFeatureParams::Meter,
              unit_transformation:
                T.nilable(
        ...
        class Meter < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::FeatureUpdateFeatureParams::Meter,
                Stigg::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              aggregation:
                Stigg::V1::FeatureUpdateFeatureParams::Meter::Aggregation::OrHash
            ).void
          end
          ...
          sig do
            params(
              ...
              filters:
                T::Array[
                  Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter::OrHash
                ]
            ).returns(T.attached_class)
          end
          ...
          sig do
            override.returns(
              {
                aggregation:
                  Stigg::V1::FeatureUpdateFeatureParams::Meter::Aggregation,
                filters:
                  T::Array[Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter]
              }
            )
            ...
            module Function
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::FeatureUpdateFeatureParams::Meter::Aggregation::Function
                  )
                end
              ...
              SUM =
                T.let(
                  :SUM,
                  Stigg::V1::FeatureUpdateFeatureParams::Meter::Aggregation::Function::TaggedSymbol
                )
              MAX =
                T.let(
                  :MAX,
          ...
          class Filter < Stigg::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter,
                  Stigg::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T::Array[
                  Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter::Condition
                ]
              )
            end
            ...
            sig do
              params(
                conditions:
                  T::Array[
                    Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter::Condition::OrHash
                  ]
              ).returns(T.attached_class)
            end
              ...
              module Operation
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter::Condition::Operation
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                EQUALS =
                  T.let(
                    :EQUALS,
                    Stigg::V1::FeatureUpdateFeatureParams::Meter::Filter::Condition::Operation::TaggedSymbol
                  )
                NOT_EQUALS =
                  T.let(
                    :NOT_EQUALS,
        ...
        class UnitTransformation < Stigg::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Stigg::V1::FeatureUpdateFeatureParams::UnitTransformation::Round::OrSymbol
              )
            )
          end
          attr_reader :round
          ...
          module Round
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::V1::FeatureUpdateFeatureParams::UnitTransformation::Round
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            UP =
              T.let(
                :UP,
                Stigg::V1::FeatureUpdateFeatureParams::UnitTransformation::Round::TaggedSymbol
              )
            DOWN =
              T.let(
                :DOWN,
