    ...
    module V1
      class ContractListResponse < Stigg::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Stigg::Models::V1::ContractListResponse::BillingState::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(Stigg::Models::V1::ContractListResponse::LatestInvoice)
          )
        end
        ...
        sig do
          params(
            latest_invoice:
              T.nilable(
                Stigg::Models::V1::ContractListResponse::LatestInvoice::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Stigg::Models::V1::ContractListResponse::NextInvoice)
          )
        end
        ...
        sig do
          params(
            next_invoice:
              T.nilable(
                Stigg::Models::V1::ContractListResponse::NextInvoice::OrHash
              )
          ).void
        end
        ...
        # The current state of the contract
        sig do
          returns(Stigg::Models::V1::ContractListResponse::State::TaggedSymbol)
        end
        attr_accessor :state
        ...
        sig do
          returns(
            T::Array[Stigg::Models::V1::ContractListResponse::Subscription]
          )
        end
        ...
        sig do
          params(
            ...
            billing_state:
              T.nilable(
                Stigg::Models::V1::ContractListResponse::BillingState::OrSymbol
              ),
            contract_id: String,
            ...
            state: Stigg::Models::V1::ContractListResponse::State::OrSymbol,
            subscriptions:
              T::Array[
                Stigg::Models::V1::ContractListResponse::Subscription::OrHash
              ]
          ...
          override.returns(
            {
              ...
              ref_id: T.nilable(String),
              state:
                Stigg::Models::V1::ContractListResponse::State::TaggedSymbol,
              subscriptions:
                T::Array[Stigg::Models::V1::ContractListResponse::Subscription]
            }
          )
        ...
        module BillingState
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Stigg::Models::V1::ContractListResponse::BillingState
              )
            end
        ...
        class LatestInvoice < Stigg::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Stigg::Models::V1::ContractListResponse::LatestInvoice::Status::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Stigg::Models::V1::ContractListResponse::LatestInvoice::BillingReason::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              status:
                Stigg::Models::V1::ContractListResponse::LatestInvoice::Status::OrSymbol,
              amount_due: T.nilable(Float),
              billing_reason:
                T.nilable(
                  Stigg::Models::V1::ContractListResponse::LatestInvoice::BillingReason::OrSymbol
                ),
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::ContractListResponse::LatestInvoice::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module BillingReason
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::ContractListResponse::LatestInvoice::BillingReason
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextInvoice < Stigg::Internal::Type::BaseModel
          ...
          class Amount < Stigg::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Stigg::Models::V1::ContractListResponse::NextInvoice::Amount::Currency::TaggedSymbol
              )
            end
            attr_accessor :currency
            ...
            sig do
              params(
                amount: Float,
                currency:
                  Stigg::Models::V1::ContractListResponse::NextInvoice::Amount::Currency::OrSymbol
              ).returns(T.attached_class)
            end
            def self.new(
              # The price amount
            ...
            module Currency
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::Models::V1::ContractListResponse::NextInvoice::Amount::Currency
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module State
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Stigg::Models::V1::ContractListResponse::State)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Subscription < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1::ContractListResponse::Subscription,
                Stigg::Internal::AnyHash
              )
            end
