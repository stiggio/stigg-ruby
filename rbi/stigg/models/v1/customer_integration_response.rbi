    ...
    module V1
      class CustomerIntegrationResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::V1::CustomerIntegrationResponse,
              Stigg::Internal::AnyHash
            )
          end

        # External billing or CRM integration link
        sig { returns(Stigg::V1::CustomerIntegrationResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::V1::CustomerIntegrationResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::CustomerIntegrationResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Stigg::V1::CustomerIntegrationResponse::Data::SyncData::Variants
              )
            )
          end
          ...
          sig do
            params(
              ...
              vendor_identifier:
                Stigg::V1::CustomerIntegrationResponse::Data::VendorIdentifier::OrSymbol,
              sync_data:
                T.nilable(
                  T.any(
                    Stigg::V1::CustomerIntegrationResponse::Data::SyncData::SyncRevisionPriceBillingData::OrHash,
                    Stigg::V1::CustomerIntegrationResponse::Data::SyncData::SyncRevisionBillingData::OrHash,
                    Stigg::V1::CustomerIntegrationResponse::Data::SyncData::SyncRevisionMarketplaceData::OrHash
                  )
                )
            ).returns(T.attached_class)
          end
          ...
          module VendorIdentifier
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::V1::CustomerIntegrationResponse::Data::VendorIdentifier
                )
              end
          ...
          module SyncData
            ...
            Variants =
              T.type_alias do
                T.any(
                  Stigg::V1::CustomerIntegrationResponse::Data::SyncData::SyncRevisionPriceBillingData,
                  Stigg::V1::CustomerIntegrationResponse::Data::SyncData::SyncRevisionBillingData,
                  Stigg::V1::CustomerIntegrationResponse::Data::SyncData::SyncRevisionMarketplaceData
                )
              end
