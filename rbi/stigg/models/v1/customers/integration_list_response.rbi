      ...
      module Customers
        class IntegrationListResponse < Stigg::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::Variants
              )
            )
          end
          ...
          sig do
            params(
              ...
              vendor_identifier:
                Stigg::Models::V1::Customers::IntegrationListResponse::VendorIdentifier::OrSymbol,
              sync_data:
                T.nilable(
                  T.any(
                    Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionPriceBillingData::OrHash,
                    Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionBillingData::OrHash,
                    Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionMarketplaceData::OrHash
                  )
                )
          ...
          module VendorIdentifier
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::Models::V1::Customers::IntegrationListResponse::VendorIdentifier
                )
              end
          ...
          module SyncData
            ...
            Variants =
              T.type_alias do
                T.any(
                  Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionPriceBillingData,
                  Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionBillingData,
                  Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionMarketplaceData
                )
              end
