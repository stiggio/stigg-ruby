      ...
      module Customers
        class PromotionalEntitlementCreateParams < Stigg::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1::Customers::PromotionalEntitlementCreateParams,
          ...
          class PromotionalEntitlement < Stigg::Internal::Type::BaseModel
            ...
            sig do
              params(
                monthly_reset_period_configuration:
                  T.nilable(
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::MonthlyResetPeriodConfiguration::OrHash
                  )
              ).void
            end
            ...
            sig do
              returns(
                Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::Period::OrSymbol
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::ResetPeriod::OrSymbol
                )
              )
            end
            ...
            sig do
              params(
                weekly_reset_period_configuration:
                  T.nilable(
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::WeeklyResetPeriodConfiguration::OrHash
                  )
              ).void
            end
            ...
            sig do
              params(
                yearly_reset_period_configuration:
                  T.nilable(
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::YearlyResetPeriodConfiguration::OrHash
                  )
              ).void
            end
            ...
            class MonthlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::MonthlyResetPeriodConfiguration::AccordingTo::OrSymbol
                )
              end
              ...
              module AccordingTo
                ...
                SUBSCRIPTION_START =
                  T.let(
                    :SubscriptionStart,
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::MonthlyResetPeriodConfiguration::AccordingTo::TaggedSymbol
                  )
                START_OF_THE_MONTH =
                  T.let(
                    :StartOfTheMonth,
            ...
            module Period
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::Period
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              PERIOD_1_WEEK =
                T.let(
                  :"1 week",
                  Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::Period::TaggedSymbol
                )
              PERIOD_1_MONTH =
                T.let(
                  :"1 month",
            ...
            module ResetPeriod
              ...
              YEAR =
                T.let(
                  :YEAR,
                  Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::ResetPeriod::TaggedSymbol
                )
              MONTH =
                T.let(
                  :MONTH,
            ...
            class WeeklyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::WeeklyResetPeriodConfiguration::AccordingTo::OrSymbol
                )
              end
              attr_accessor :according_to
              ...
              module AccordingTo
                ...
                SUBSCRIPTION_START =
                  T.let(
                    :SubscriptionStart,
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::WeeklyResetPeriodConfiguration::AccordingTo::TaggedSymbol
                  )
                EVERY_SUNDAY =
                  T.let(
                    :EverySunday,
            ...
            class YearlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::YearlyResetPeriodConfiguration::AccordingTo::OrSymbol
                )
              end
              attr_accessor :according_to
              ...
              module AccordingTo
                ...
                SUBSCRIPTION_START =
                  T.let(
                    :SubscriptionStart,
                    Stigg::V1::Customers::PromotionalEntitlementCreateParams::PromotionalEntitlement::YearlyResetPeriodConfiguration::AccordingTo::TaggedSymbol
                  )
