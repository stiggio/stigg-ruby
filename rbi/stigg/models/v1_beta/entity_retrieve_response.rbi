    ...
    module V1Beta
      class EntityRetrieveResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1Beta::EntityRetrieveResponse,
              Stigg::Internal::AnyHash
            )
          end

        # A stored entity instance tracked by the governance service for a given customer
        sig { returns(Stigg::Models::V1Beta::EntityRetrieveResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1Beta::EntityRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1Beta::EntityRetrieveResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
