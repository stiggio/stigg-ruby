      ...
      module Customers
        class EntityListParams < Stigg::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1Beta::Customers::EntityListParams,
          ...
          module IncludeArchived
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Stigg::V1Beta::Customers::EntityListParams::IncludeArchived
                )
              end
            ...
            TRUE =
              T.let(
                :true,
                Stigg::V1Beta::Customers::EntityListParams::IncludeArchived::TaggedSymbol
              )
            FALSE =
              T.let(
                :false,
