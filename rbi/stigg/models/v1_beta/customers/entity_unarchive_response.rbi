      ...
      module Customers
        class EntityUnarchiveResponse < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse,
          ...
          sig do
            returns(
              Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse::Data
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse::Data::OrHash
            ).void
          end
          attr_writer :data
