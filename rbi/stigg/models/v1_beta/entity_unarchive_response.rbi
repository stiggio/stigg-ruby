    ...
    module V1Beta
      class EntityUnarchiveResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1Beta::EntityUnarchiveResponse,
              Stigg::Internal::AnyHash
            )
          end

        # List of entity identifiers that were acted on
        sig { returns(Stigg::Models::V1Beta::EntityUnarchiveResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1Beta::EntityUnarchiveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1Beta::EntityUnarchiveResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
