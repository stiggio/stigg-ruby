    ...
    module V1Beta
      class EntityTypeUpsertResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1Beta::EntityTypeUpsertResponse,
        ...
        sig do
          returns(
            T::Array[Stigg::Models::V1Beta::EntityTypeUpsertResponse::Data]
          )
        end
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T::Array[
                Stigg::Models::V1Beta::EntityTypeUpsertResponse::Data::OrHash
              ]
