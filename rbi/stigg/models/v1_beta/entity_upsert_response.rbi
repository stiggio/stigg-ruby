    ...
    module V1Beta
      class EntityUpsertResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1Beta::EntityUpsertResponse,
              Stigg::Internal::AnyHash
            )
          end

        sig do
          returns(T::Array[Stigg::Models::V1Beta::EntityUpsertResponse::Data])
        end
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T::Array[
                Stigg::Models::V1Beta::EntityUpsertResponse::Data::OrHash
              ]
        ...
        sig do
          override.returns(
            {
              data: T::Array[Stigg::Models::V1Beta::EntityUpsertResponse::Data]
            }
          )
        end
        def to_hash
