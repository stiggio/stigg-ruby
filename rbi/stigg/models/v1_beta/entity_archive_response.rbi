    ...
    module V1Beta
      class EntityArchiveResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1Beta::EntityArchiveResponse,
              Stigg::Internal::AnyHash
            )
          end

        # List of entity identifiers that were acted on
        sig { returns(Stigg::Models::V1Beta::EntityArchiveResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Stigg::Models::V1Beta::EntityArchiveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::Models::V1Beta::EntityArchiveResponse::Data,
                Stigg::Internal::AnyHash
              )
            end
