  ...
  module Models
    module V1Beta
      class EntityUpsertParams < Stigg::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(Stigg::V1Beta::EntityUpsertParams, Stigg::Internal::AnyHash)
          end
        ...
        sig { returns(T::Array[Stigg::V1Beta::EntityUpsertParams::Entity]) }
        ...
        sig do
          override.returns(
            {
              id: String,
              entities: T::Array[Stigg::V1Beta::EntityUpsertParams::Entity],
        ...
        class Entity < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V1Beta::EntityUpsertParams::Entity,
