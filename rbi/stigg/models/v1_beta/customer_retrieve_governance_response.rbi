    ...
    module V1Beta
      class CustomerRetrieveGovernanceResponse < Stigg::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Stigg::Models::V1Beta::CustomerRetrieveGovernanceResponse,
        ...
        sig do
          returns(
            T::Array[
              Stigg::Models::V1Beta::CustomerRetrieveGovernanceResponse::Data
            ]
          )
        end
        attr_accessor :data
        ...
        sig do
          returns(
            Stigg::Models::V1Beta::CustomerRetrieveGovernanceResponse::Pagination
          )
        end
        ...
        sig do
          params(
            pagination:
              Stigg::Models::V1Beta::CustomerRetrieveGovernanceResponse::Pagination::OrHash
          ).void
        end
        ...
        sig do
          params(
            data:
              T::Array[
                Stigg::Models::V1Beta::CustomerRetrieveGovernanceResponse::Data::OrHash
              ],
            pagination:
              Stigg::Models::V1Beta::CustomerRetrieveGovernanceResponse::Pagination::OrHash
