    ...
    module V1Beta
      class CustomerRetrieveGovernanceParams < Stigg::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Stigg::V1Beta::CustomerRetrieveGovernanceParams,
        ...
        module Order
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Stigg::V1Beta::CustomerRetrieveGovernanceParams::Order
              )
            end
          ...
          ASC =
            T.let(
              :asc,
              Stigg::V1Beta::CustomerRetrieveGovernanceParams::Order::TaggedSymbol
            )
          DESC =
            T.let(
              :desc,
        ...
        module Scope
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Stigg::V1Beta::CustomerRetrieveGovernanceParams::Scope
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          ALL =
            T.let(
              :all,
              Stigg::V1Beta::CustomerRetrieveGovernanceParams::Scope::TaggedSymbol
            )
          NODE_WIDE =
            T.let(
              :nodeWide,
        ...
        module SortBy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Stigg::V1Beta::CustomerRetrieveGovernanceParams::SortBy
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          UTILIZATION =
            T.let(
              :utilization,
              Stigg::V1Beta::CustomerRetrieveGovernanceParams::SortBy::TaggedSymbol
            )
          CURRENT_USAGE =
            T.let(
              :currentUsage,
