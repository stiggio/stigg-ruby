  ...
  module Models
    module V1Beta
      class EntityListParams < Stigg::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(Stigg::V1Beta::EntityListParams, Stigg::Internal::AnyHash)
          end
        ...
        module IncludeArchived
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Stigg::V1Beta::EntityListParams::IncludeArchived)
            end
          ...
          TRUE =
            T.let(
              :true,
              Stigg::V1Beta::EntityListParams::IncludeArchived::TaggedSymbol
            )
          FALSE =
            T.let(
              :false,
