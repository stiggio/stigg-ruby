  ...
  module Models
    module V2
      class PermissionCheckParams < Stigg::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(Stigg::V2::PermissionCheckParams, Stigg::Internal::AnyHash)
          end
        ...
        sig do
          returns(
            T::Array[Stigg::V2::PermissionCheckParams::ResourcesAndAction]
          )
        end
        ...
        class ResourcesAndAction < Stigg::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Stigg::V2::PermissionCheckParams::ResourcesAndAction,
