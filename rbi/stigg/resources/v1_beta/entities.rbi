    ...
    class V1Beta
      class Entities
        ...
        sig do
          ...
          ).returns(Stigg::Models::V1Beta::EntityRetrieveResponse)
        end
        def retrieve(
        ...
        sig do
          params(
            ...
            before: String,
            include_archived:
              Stigg::V1Beta::EntityListParams::IncludeArchived::OrSymbol,
            limit: Integer,
            type_ref_id: String,
            request_options: Stigg::RequestOptions::OrHash
          ).returns(
            Stigg::Internal::MyCursorIDPage[
              Stigg::Models::V1Beta::EntityListResponse
            ]
          )
        end
        def list(
        ...
        sig do
          params(
            ...
            ids: T::Array[String],
            request_options: Stigg::RequestOptions::OrHash
          ).returns(Stigg::Models::V1Beta::EntityArchiveResponse)
        end
        def archive(
          # The customer identifier (owner) the entities belong to
          id,
        ...
        sig do
          params(
            ...
            ids: T::Array[String],
            request_options: Stigg::RequestOptions::OrHash
          ).returns(Stigg::Models::V1Beta::EntityUnarchiveResponse)
        end
        def unarchive(
          # The customer identifier (owner) the entities belong to
          id,
        ...
        sig do
          params(
            id: String,
            entities:
              T::Array[Stigg::V1Beta::EntityUpsertParams::Entity::OrHash],
            request_options: Stigg::RequestOptions::OrHash
          ).returns(Stigg::Models::V1Beta::EntityUpsertResponse)
        end
        def upsert(
          # The customer identifier (owner) the entities belong to
          id,
