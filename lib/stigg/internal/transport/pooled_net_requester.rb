      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Stigg::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Stigg::Internal::Util.uri_origin(url)
          timeout = deadline - Stigg::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Stigg::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Stigg::Errors::APIConnectionError.new(url: url, request: req)
          end
