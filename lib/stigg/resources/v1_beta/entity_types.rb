  ...
  module Resources
    class V1Beta
      class EntityTypes
        ...
        # {Stigg::Models::V1Beta::EntityTypeListParams} for more details.
        #
        ...
        #
        # @return [Stigg::Internal::MyCursorIDPage<Stigg::Models::V1Beta::EntityTypeListResponse>]
        #
        # @see Stigg::Models::V1Beta::EntityTypeListParams
        def list(params = {})
        ...
        # Some parameter documentations has been truncated, see
        # {Stigg::Models::V1Beta::EntityTypeUpsertParams} for more details.
        #
        ...
        #
        # @param types [Array<Stigg::Models::V1Beta::EntityTypeUpsertParams::Type>] Body param: Entity types to upsert (1–100 per request)
        #
        # @param x_account_id [String] Header param: Account ID — optional when authenticating with a user JWT (Bearer
        #
        # @param x_environment_id [String] Header param: Environment ID — required when authenticating with a user JWT (Bea
        ...
        # @param request_options [Stigg::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Stigg::Models::V1Beta::EntityTypeUpsertResponse]
        #
        # @see Stigg::Models::V1Beta::EntityTypeUpsertParams
        def upsert(params)
