      ...
      class Events
        class Credits
          ...
          class CustomCurrencies
            ...
            #
            # @return [Stigg::Models::V1::Events::Credits::CustomCurrencyCreateResponse]
            #
            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyCreateParams
            def create(params)
            ...
            # @param request_options [Stigg::RequestOptions, Hash{Symbol=>Object}, nil]
            #
            # @return [Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse]
            #
            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateParams
            ...
            # @param request_options [Stigg::RequestOptions, Hash{Symbol=>Object}, nil]
            #
            # @return [Stigg::Internal::MyCursorIDPage<Stigg::Models::V1::Events::Credits::CustomCurrencyListResponse>]
            #
            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyListParams
            def list(params = {})
            ...
            # @param request_options [Stigg::RequestOptions, Hash{Symbol=>Object}, nil]
            #
            # @return [Stigg::Models::V1::Events::Credits::CustomCurrencyArchiveResponse]
            #
            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyArchiveParams
            ...
            # @param request_options [Stigg::RequestOptions, Hash{Symbol=>Object}, nil]
            #
            # @return [Stigg::Models::V1::Events::Credits::CustomCurrencyListAssociatedEntitiesResponse]
            #
            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyListAssociatedEntitiesParams
            ...
            # @param request_options [Stigg::RequestOptions, Hash{Symbol=>Object}, nil]
            #
            # @return [Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse]
            #
            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveParams
