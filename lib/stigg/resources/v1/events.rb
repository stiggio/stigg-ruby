  ...
  module Resources
    class V1
      ...
      class Events
        ...
        #
        # @overload estimate(customer_id:, event_name:, dimensions: nil, resource_id: nil, x_account_id: nil, x_environment_id: nil, request_options: {})
        #
        ...
        #
        # @return [Stigg::Models::V1::EventEstimateResponse]
        #
        # @see Stigg::Models::V1::EventEstimateParams
        def estimate(params)
          parsed, options = Stigg::V1::EventEstimateParams.dump_request(params)
          ...
          @client.request(
            ...
            model: Stigg::Models::V1::EventEstimateResponse,
            options: options
          )
        end
