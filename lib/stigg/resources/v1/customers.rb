  ...
  module Resources
    class V1
      class Customers
        ...
        #
        # @return [Stigg::Models::V1::CustomerGetCustomerResponse]
        #
        # @see Stigg::Models::V1::CustomerGetCustomerParams
        def get_customer(ref_id, params)
          parsed, options = Stigg::V1::CustomerGetCustomerParams.dump_request(params)
          @client.request(
            method: :get,
            path: ["api/v1/customers/%1$s", ref_id],
            headers: parsed.transform_keys(x_api_key: "x-api-key", x_environment_id: "x-environment-id"),
            model: Stigg::Models::V1::CustomerGetCustomerResponse,
            options: options
          )
        end
