    ...
    module Internal
      module Beta
        ...
        class EventQueueUpdateParams < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Symbol, Stigg::Models::Internal::Beta::EventQueueUpdateParams::EventType>, nil]
          optional :event_types,
                   -> { Stigg::Internal::Type::ArrayOf[enum: Stigg::Models::Internal::Beta::EventQueueUpdateParams::EventType] },
                   api_name: :eventTypes

          # @!method initialize(queue_name:, allowed_assume_role_arns: nil, create_low_priority_queues: nil, event_types: nil, request_options: {})
