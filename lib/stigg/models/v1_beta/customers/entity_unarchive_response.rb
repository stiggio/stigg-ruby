    ...
    module V1Beta
      module Customers
        ...
        class EntityUnarchiveResponse < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse::Data]
          required :data, -> { Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse::Data }

          # @!method initialize(data:)
          #   Wrapped response echoing the ids that were acted on by an archive/unarchive call
          #
          #   @param data [Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse::Data] List of entity identifiers that were acted on

          # @see Stigg::Models::V1Beta::Customers::EntityUnarchiveResponse#data
