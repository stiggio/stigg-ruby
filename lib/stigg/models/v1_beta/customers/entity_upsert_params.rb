    ...
    module V1Beta
      module Customers
        ...
        class EntityUpsertParams < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Stigg::Models::V1Beta::Customers::EntityUpsertParams::Entity>]
          required :entities,
                   -> { Stigg::Internal::Type::ArrayOf[Stigg::V1Beta::Customers::EntityUpsertParams::Entity] }
          ...
          #   @param id [String]
          #
          #   @param entities [Array<Stigg::Models::V1Beta::Customers::EntityUpsertParams::Entity>] List of entities to create or update (1-100 entries)
          #
