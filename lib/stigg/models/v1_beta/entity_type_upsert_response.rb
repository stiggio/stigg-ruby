  ...
  module Models
    module V1Beta
      ...
      class EntityTypeUpsertResponse < Stigg::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Stigg::Models::V1Beta::EntityTypeUpsertResponse::Data>]
        required :data,
                 -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1Beta::EntityTypeUpsertResponse::Data] }

        # @!method initialize(data:)
        #   Entity types after upsert.
        #
        #   @param data [Array<Stigg::Models::V1Beta::EntityTypeUpsertResponse::Data>]
