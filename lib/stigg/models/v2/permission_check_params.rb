...
module Stigg
  module Models
    module V2
      # @see Stigg::Resources::V2::Permissions#check
      class PermissionCheckParams < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Stigg::Models::V2::PermissionCheckParams::ResourcesAndAction>]
        required :resources_and_actions,
                 -> { Stigg::Internal::Type::ArrayOf[Stigg::V2::PermissionCheckParams::ResourcesAndAction] },
        ...
        #
        #   @param resources_and_actions [Array<Stigg::Models::V2::PermissionCheckParams::ResourcesAndAction>] List of resources and actions to check permissions for
        #
