    ...
    module V1
      module Addons
        ...
        class EntitlementCreateParams < Stigg::Internal::Type::BaseModel
          ...
          # @!method initialize(addon_id:, entitlements:, x_account_id: nil, x_environment_id: nil, request_options: {})
          ...
          module Entitlement
            ...
            class Feature < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::Behavior, nil]
              optional :behavior,
                       enum: -> { Stigg::V1::Addons::EntitlementCreateParams::Entitlement::Feature::Behavior }
              ...
              #
              #   @return [Array<Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::HiddenFromWidget>, nil]
              optional :hidden_from_widgets,
                       -> {
                         Stigg::Internal::Type::ArrayOf[enum: Stigg::V1::Addons::EntitlementCreateParams::Entitlement::Feature::HiddenFromWidget]
                       },
              ...
              #
              #   @return [Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration, nil]
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::ResetPeriod, nil]
              ...
              #
              #   @return [Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration, nil]
              ...
              #
              #   @return [Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::YearlyResetPeriodConfiguration, nil]
              ...
              #
              #   @param hidden_from_widgets [Array<Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::HiddenFromWidget>] Widget types where this entitlement is hidden
              #
              #   @param is_custom [Boolean] Whether this is a custom entitlement
              #
              #   @param is_granted [Boolean] Whether the entitlement is granted
              #
              #   @param monthly_reset_period_configuration [Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration, nil] Configuration for monthly reset period
              #
              #   @param order [Float] Display order of the entitlement
              #
              #   @param reset_period [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::ResetPeriod] Period at which usage resets
              #
              ...
              # Entitlement behavior (Increment or Override)
              #
              # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature#behavior
              module Behavior
              ...
              # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature#monthly_reset_period_configuration
              class MonthlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                # @!attribute according_to
                #   Reset anchor (SubscriptionStart or StartOfTheMonth)
                #
                #   @return [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration::AccordingTo]
                ...
                #   Configuration for monthly reset period
                #
                #   @param according_to [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart or StartOfTheMonth)

                # Reset anchor (SubscriptionStart or StartOfTheMonth)
                #
                # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::MonthlyResetPeriodConfiguration#according_to
                module AccordingTo
                  extend Stigg::Internal::Type::Enum
              ...
              # Period at which usage resets
              #
              # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature#reset_period
              module ResetPeriod
                extend Stigg::Internal::Type::Enum
              ...
              # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature#weekly_reset_period_configuration
              class WeeklyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                # @!attribute according_to
                #   Reset anchor (SubscriptionStart or specific day)
                #
                #   @return [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration::AccordingTo]
                required :according_to,
                         enum: -> {
                ...
                #   Configuration for weekly reset period
                #
                #   @param according_to [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart or specific day)

                # Reset anchor (SubscriptionStart or specific day)
                #
                # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::WeeklyResetPeriodConfiguration#according_to
                module AccordingTo
                  extend Stigg::Internal::Type::Enum
              ...
              # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature#yearly_reset_period_configuration
              class YearlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                # @!attribute according_to
                #   Reset anchor (SubscriptionStart)
                #
                #   @return [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::YearlyResetPeriodConfiguration::AccordingTo]
                required :according_to,
                         enum: -> {
                ...
                #   Configuration for yearly reset period
                #
                #   @param according_to [Symbol, Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::YearlyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart)

                # Reset anchor (SubscriptionStart)
                #
                # @see Stigg::Models::V1::Addons::EntitlementCreateParams::Entitlement::Feature::YearlyResetPeriodConfiguration#according_to
                module AccordingTo
                  extend Stigg::Internal::Type::Enum
