...
module Stigg
  module Models
    module V1
      # @see Stigg::Resources::V1::Contracts#delete
      class ContractDeleteResponse < Stigg::Internal::Type::BaseModel
        # @!attribute data
        #   A billing contract as reported by the connected billing provider.
        #
        #   @return [Stigg::Models::V1::ContractDeleteResponse::Data]
        required :data, -> { Stigg::Models::V1::ContractDeleteResponse::Data }

        # @!method initialize(data:)
        #   Response object
        #
        #   @param data [Stigg::Models::V1::ContractDeleteResponse::Data] A billing contract as reported by the connected billing provider.

        # @see Stigg::Models::V1::ContractDeleteResponse#data
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice, nil]
          required :latest_invoice,
                   -> { Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice },
          ...
          #
          #   @return [Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice, nil]
          required :next_invoice,
                   -> { Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::State]
          required :state, enum: -> { Stigg::Models::V1::ContractDeleteResponse::Data::State }

          # @!attribute subscriptions
          #   The custom subscriptions attached to this contract (empty when none)
          #
          #   @return [Array<Stigg::Models::V1::ContractDeleteResponse::Data::Subscription>]
          ...
          #
          #   @param latest_invoice [Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice, nil] The most recent non-draft invoice for this contract (open, paid, or canceled), o
          #
          #   @param name [String, nil] The contract name (the purchase-order number when set, otherwise the contract/cu
          #
          #   @param next_invoice [Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice, nil] A preview of the contract's upcoming invoice, or null when none is available
          #
          ...
          #
          #   @param state [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::State] The current state of the contract
          #
          ...
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            #   Invoice status
            #
            #   @return [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::Status]
            required :status, enum: -> { Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::Status }
            ...
            #   Billing reason
            #
            #   @return [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::BillingReason, nil]
            optional :billing_reason,
                     enum: -> { Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::BillingReason },
            ...
            #
            #   @param status [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::Status] Invoice status
            #
            #   @param amount_due [Float, nil] Amount due
            #
            #   @param billing_reason [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice::BillingReason, nil] Billing reason
            #
            ...
            # Invoice status
            #
            # @see Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice#status
            module Status
            ...
            # Billing reason
            #
            # @see Stigg::Models::V1::ContractDeleteResponse::Data::LatestInvoice#billing_reason
          ...
          # @see Stigg::Models::V1::ContractDeleteResponse::Data#next_invoice
          class NextInvoice < Stigg::Internal::Type::BaseModel
            # @!attribute amount
            #   The total amount of the upcoming invoice
            #
            #   @return [Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount]
            required :amount, -> { Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount }
            ...
            #   A preview of the contract's upcoming invoice, or null when none is available
            #
            #   @param amount [Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount] The total amount of the upcoming invoice
            #
            ...
            # @see Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice#amount
            class Amount < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount::Currency]
              required :currency,
                       enum: -> { Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount::Currency }
              ...
              #
              #   @param currency [Symbol, Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount::Currency] ISO 4217 currency code

              # ISO 4217 currency code
              #
              # @see Stigg::Models::V1::ContractDeleteResponse::Data::NextInvoice::Amount#currency
              module Currency
                extend Stigg::Internal::Type::Enum
          ...
          # The current state of the contract
          #
          # @see Stigg::Models::V1::ContractDeleteResponse::Data#state
          module State
            extend Stigg::Internal::Type::Enum
