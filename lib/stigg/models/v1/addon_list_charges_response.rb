...
module Stigg
  module Models
    module V1
      # @see Stigg::Resources::V1::Addons#list_charges
      class AddonListChargesResponse < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::BillingCadence]
        required :billing_cadence,
                 enum: -> { Stigg::Models::V1::AddonListChargesResponse::BillingCadence },
                 api_name: :billingCadence

        # @!attribute billing_model
        #   The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
        #
        #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::BillingModel]
        required :billing_model,
                 enum: -> { Stigg::Models::V1::AddonListChargesResponse::BillingModel },
                 api_name: :billingModel

        # @!attribute billing_period
        #   The billing period (MONTHLY or ANNUALLY)
        #
        #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::BillingPeriod]
        required :billing_period,
                 enum: -> { Stigg::Models::V1::AddonListChargesResponse::BillingPeriod },
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::CreditGrantCadence, nil]
        optional :credit_grant_cadence,
                 enum: -> { Stigg::Models::V1::AddonListChargesResponse::CreditGrantCadence },
        ...
        #
        #   @return [Stigg::Models::V1::AddonListChargesResponse::CreditRate, nil]
        ...
        #
        #   @return [Stigg::Models::V1::AddonListChargesResponse::Price, nil]
        optional :price, -> { Stigg::Models::V1::AddonListChargesResponse::Price }, nil?: true

        # @!attribute tiers
        #   Tiered pricing rows when the charge is tiered
        #
        #   @return [Array<Stigg::Models::V1::AddonListChargesResponse::Tier>, nil]
        optional :tiers,
                 -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::AddonListChargesResponse::Tier] },
                 nil?: true

        # @!attribute tiers_mode
        #   Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
        #
        #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::TiersMode, nil]
        optional :tiers_mode,
                 enum: -> { Stigg::Models::V1::AddonListChargesResponse::TiersMode },
                 api_name: :tiersMode,
                 nil?: true
        ...
        #   {Stigg::Models::V1::AddonListChargesResponse} for more details.
        #
        ...
        #
        #   @param billing_cadence [Symbol, Stigg::Models::V1::AddonListChargesResponse::BillingCadence] The billing cadence (RECURRING or ONE_OFF)
        #
        #   @param billing_model [Symbol, Stigg::Models::V1::AddonListChargesResponse::BillingModel] The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
        #
        #   @param billing_period [Symbol, Stigg::Models::V1::AddonListChargesResponse::BillingPeriod] The billing period (MONTHLY or ANNUALLY)
        #
        ...
        #
        #   @param credit_grant_cadence [Symbol, Stigg::Models::V1::AddonListChargesResponse::CreditGrantCadence, nil] When credits are granted (for credit-based pricing)
        #
        #   @param credit_rate [Stigg::Models::V1::AddonListChargesResponse::CreditRate, nil] Credit rate configuration for credit-based pricing
        #
        ...
        #
        #   @param price [Stigg::Models::V1::AddonListChargesResponse::Price, nil] The flat price amount and currency, when applicable
        #
        #   @param tiers [Array<Stigg::Models::V1::AddonListChargesResponse::Tier>, nil] Tiered pricing rows when the charge is tiered
        #
        #   @param tiers_mode [Symbol, Stigg::Models::V1::AddonListChargesResponse::TiersMode, nil] Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
        #
        ...
        # The billing cadence (RECURRING or ONE_OFF)
        #
        # @see Stigg::Models::V1::AddonListChargesResponse#billing_cadence
        ...
        # The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
        #
        # @see Stigg::Models::V1::AddonListChargesResponse#billing_model
        module BillingModel
          extend Stigg::Internal::Type::Enum
        ...
        # The billing period (MONTHLY or ANNUALLY)
        #
        # @see Stigg::Models::V1::AddonListChargesResponse#billing_period
        ...
        # When credits are granted (for credit-based pricing)
        #
        # @see Stigg::Models::V1::AddonListChargesResponse#credit_grant_cadence
        ...
        # @see Stigg::Models::V1::AddonListChargesResponse#credit_rate
        ...
        # @see Stigg::Models::V1::AddonListChargesResponse#price
        class Price < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::Price::Currency]
          required :currency, enum: -> { Stigg::Models::V1::AddonListChargesResponse::Price::Currency }
          ...
          #
          #   @param currency [Symbol, Stigg::Models::V1::AddonListChargesResponse::Price::Currency] ISO 4217 currency code

          # ISO 4217 currency code
          #
          # @see Stigg::Models::V1::AddonListChargesResponse::Price#currency
          module Currency
            extend Stigg::Internal::Type::Enum
        ...
        class Tier < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::AddonListChargesResponse::Tier::FlatPrice, nil]
          optional :flat_price,
          ...
          #
          #   @return [Stigg::Models::V1::AddonListChargesResponse::Tier::UnitPrice, nil]
          optional :unit_price,
          ...
          #
          #   @param flat_price [Stigg::Models::V1::AddonListChargesResponse::Tier::FlatPrice, nil] Flat price for this tier
          #
          #   @param unit_price [Stigg::Models::V1::AddonListChargesResponse::Tier::UnitPrice, nil] Per-unit price in this tier
          #
          #   @param up_to [Float, nil] Upper bound of this tier (null for unlimited)

          # @see Stigg::Models::V1::AddonListChargesResponse::Tier#flat_price
          class FlatPrice < Stigg::Internal::Type::BaseModel
            ...
            #   ISO 4217 currency code
            #
            #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::Tier::FlatPrice::Currency]
            required :currency, enum: -> { Stigg::Models::V1::AddonListChargesResponse::Tier::FlatPrice::Currency }
            ...
            #   @param amount [Float] The price amount
            #
            #   @param currency [Symbol, Stigg::Models::V1::AddonListChargesResponse::Tier::FlatPrice::Currency] ISO 4217 currency code

            # ISO 4217 currency code
            #
            # @see Stigg::Models::V1::AddonListChargesResponse::Tier::FlatPrice#currency
            module Currency
              extend Stigg::Internal::Type::Enum
          ...
          # @see Stigg::Models::V1::AddonListChargesResponse::Tier#unit_price
          class UnitPrice < Stigg::Internal::Type::BaseModel
            ...
            #   ISO 4217 currency code
            #
            #   @return [Symbol, Stigg::Models::V1::AddonListChargesResponse::Tier::UnitPrice::Currency]
            required :currency, enum: -> { Stigg::Models::V1::AddonListChargesResponse::Tier::UnitPrice::Currency }
            ...
            #   @param amount [Float] The price amount
            #
            #   @param currency [Symbol, Stigg::Models::V1::AddonListChargesResponse::Tier::UnitPrice::Currency] ISO 4217 currency code

            # ISO 4217 currency code
            #
            # @see Stigg::Models::V1::AddonListChargesResponse::Tier::UnitPrice#currency
            module Currency
              extend Stigg::Internal::Type::Enum
        ...
        # Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
        #
        # @see Stigg::Models::V1::AddonListChargesResponse#tiers_mode
        module TiersMode
          extend Stigg::Internal::Type::Enum
