  ...
  module Models
    module V1
      ...
      class ProductUpdateProductResponse < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [Stigg::Models::V1::ProductUpdateProductResponse::Data]
        required :data, -> { Stigg::Models::V1::ProductUpdateProductResponse::Data }

        # @!method initialize(data:)
        #   Response object
        #
        #   @param data [Stigg::Models::V1::ProductUpdateProductResponse::Data] Product configuration object

        # @see Stigg::Models::V1::ProductUpdateProductResponse#data
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::Status]
          required :status, enum: -> { Stigg::Models::V1::ProductUpdateProductResponse::Data::Status }
          ...
          #
          #   @return [Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings, nil]
          ...
          #
          #   @param status [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::Status] The status of the product
          #
          #   @param updated_at [Time] Timestamp of when the record was last updated
          #
          #   @param product_settings [Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings] Product behavior settings for subscription lifecycle management.

          # The status of the product
          #
          # @see Stigg::Models::V1::ProductUpdateProductResponse::Data#status
          module Status
          ...
          # @see Stigg::Models::V1::ProductUpdateProductResponse::Data#product_settings
          class ProductSettings < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionCancellationTime]
            required :subscription_cancellation_time,
                     enum: -> { Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionCancellationTime },
                     api_name: :subscriptionCancellationTime

            # @!attribute subscription_end_setup
            #   Setup for the end of the subscription
            #
            #   @return [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionEndSetup]
            required :subscription_end_setup,
                     enum: -> { Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionEndSetup },
                     api_name: :subscriptionEndSetup

            # @!attribute subscription_start_setup
            #   Setup for the start of the subscription
            #
            #   @return [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionStartSetup]
            required :subscription_start_setup,
                     enum: -> { Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionStartSetup },
            ...
            #   {Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings} for
            #   more details.
            #
            #   Product behavior settings for subscription lifecycle management.
            #
            #   @param subscription_cancellation_time [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionCancellationTime] Time when the subscription will be cancelled
            #
            #   @param subscription_end_setup [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionEndSetup] Setup for the end of the subscription
            #
            #   @param subscription_start_setup [Symbol, Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings::SubscriptionStartSetup] Setup for the start of the subscription
            #
            ...
            # Time when the subscription will be cancelled
            #
            # @see Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings#subscription_cancellation_time
            ...
            # Setup for the end of the subscription
            #
            # @see Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings#subscription_end_setup
            ...
            # Setup for the start of the subscription
            #
            # @see Stigg::Models::V1::ProductUpdateProductResponse::Data::ProductSettings#subscription_start_setup
