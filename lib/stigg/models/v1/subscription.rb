    ...
    module V1
      ...
      class Subscription < Stigg::Internal::Type::BaseModel
        ...
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Subscription::Data::Budget, nil]
          ...
          #
          #   @return [Array<Stigg::Models::V1::Subscription::Data::Coupon>, nil]
          ...
          #
          #   @return [Array<Stigg::Models::V1::Subscription::Data::FutureUpdate>, nil]
          ...
          #
          #   @return [Stigg::Models::V1::Subscription::Data::LatestInvoice, nil]
          ...
          #
          #   @return [Stigg::Models::V1::Subscription::Data::MinimumSpend, nil]
          ...
          #
          #   @return [Array<Stigg::Models::V1::Subscription::Data::SubscriptionEntitlement>, nil]
          ...
          #   Trial configuration
          #
          #   @return [Stigg::Models::V1::Subscription::Data::Trial, nil]
          ...
          #
          #   @param budget [Stigg::Models::V1::Subscription::Data::Budget, nil] Budget configuration
          #
          ...
          #
          #   @param future_updates [Array<Stigg::Models::V1::Subscription::Data::FutureUpdate>] Scheduled future updates for the subscription
          #
          #   @param latest_invoice [Stigg::Models::V1::Subscription::Data::LatestInvoice, nil] Latest invoice for the subscription
          #
          #   @param metadata [Hash{Symbol=>String}] Additional metadata for the subscription
          #
          #   @param minimum_spend [Stigg::Models::V1::Subscription::Data::MinimumSpend, nil] Minimum spend configuration
          #
          ...
          #
          #   @param subscription_entitlements [Array<Stigg::Models::V1::Subscription::Data::SubscriptionEntitlement>] Entitlements associated with the subscription
          #
          #   @param trial [Stigg::Models::V1::Subscription::Data::Trial, nil] Trial configuration
          #
          ...
          # @see Stigg::Models::V1::Subscription::Data#budget
          ...
          class Coupon < Stigg::Internal::Type::BaseModel
            ...
            #   Coupon status
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::Coupon::Status]
            required :status, enum: -> { Stigg::V1::Subscription::Data::Coupon::Status }

            # @!attribute amounts_off
            #   Fixed amount discounts by currency
            #
            #   @return [Array<Stigg::Models::V1::Subscription::Data::Coupon::AmountsOff>, nil]
            optional :amounts_off,
                     -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::Subscription::Data::Coupon::AmountsOff] },
                     api_name: :amountsOff,
                     nil?: true
            ...
            #
            #   @param status [Symbol, Stigg::Models::V1::Subscription::Data::Coupon::Status] Coupon status
            #
            #   @param amounts_off [Array<Stigg::Models::V1::Subscription::Data::Coupon::AmountsOff>, nil] Fixed amount discounts by currency
            #
            #   @param percent_off [Float, nil] Percentage discount

            # Coupon status
            #
            # @see Stigg::Models::V1::Subscription::Data::Coupon#status
            module Status
              extend Stigg::Internal::Type::Enum
            ...
            class AmountsOff < Stigg::Internal::Type::BaseModel
              ...
              #   The price currency
              #
              #   @return [Symbol, Stigg::Models::V1::Subscription::Data::Coupon::AmountsOff::Currency, nil]
              optional :currency, enum: -> { Stigg::V1::Subscription::Data::Coupon::AmountsOff::Currency }

              # @!method initialize(amount: nil, currency: nil)
              #   @param amount [Float] The price amount
              #
              #   @param currency [Symbol, Stigg::Models::V1::Subscription::Data::Coupon::AmountsOff::Currency] The price currency

              # The price currency
              #
              # @see Stigg::Models::V1::Subscription::Data::Coupon::AmountsOff#currency
              module Currency
                extend Stigg::Internal::Type::Enum
          ...
          class FutureUpdate < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::FutureUpdate::ScheduleStatus]
            required :schedule_status,
                     enum: -> { Stigg::V1::Subscription::Data::FutureUpdate::ScheduleStatus },
                     api_name: :scheduleStatus

            # @!attribute subscription_schedule_type
            #   Type of scheduled change
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::FutureUpdate::SubscriptionScheduleType]
            required :subscription_schedule_type,
                     enum: -> { Stigg::V1::Subscription::Data::FutureUpdate::SubscriptionScheduleType },
                     api_name: :subscriptionScheduleType

            # @!attribute target_package
            #   Target package for the update
            #
            #   @return [Stigg::Models::V1::Subscription::Data::FutureUpdate::TargetPackage, nil]
            ...
            #
            #   @param schedule_status [Symbol, Stigg::Models::V1::Subscription::Data::FutureUpdate::ScheduleStatus] Status of the scheduled update
            #
            #   @param subscription_schedule_type [Symbol, Stigg::Models::V1::Subscription::Data::FutureUpdate::SubscriptionScheduleType] Type of scheduled change
            #
            #   @param target_package [Stigg::Models::V1::Subscription::Data::FutureUpdate::TargetPackage, nil] Target package for the update

            # Status of the scheduled update
            #
            # @see Stigg::Models::V1::Subscription::Data::FutureUpdate#schedule_status
            ...
            # Type of scheduled change
            #
            # @see Stigg::Models::V1::Subscription::Data::FutureUpdate#subscription_schedule_type
            ...
            # @see Stigg::Models::V1::Subscription::Data::FutureUpdate#target_package
          ...
          # @see Stigg::Models::V1::Subscription::Data#latest_invoice
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            #   Invoice status
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::LatestInvoice::Status]
            required :status, enum: -> { Stigg::V1::Subscription::Data::LatestInvoice::Status }
            ...
            #   Billing reason
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::LatestInvoice::BillingReason, nil]
            optional :billing_reason,
                     enum: -> { Stigg::V1::Subscription::Data::LatestInvoice::BillingReason },
            ...
            #
            #   @param status [Symbol, Stigg::Models::V1::Subscription::Data::LatestInvoice::Status] Invoice status
            #
            #   @param amount_due [Float, nil] Amount due
            #
            #   @param billing_reason [Symbol, Stigg::Models::V1::Subscription::Data::LatestInvoice::BillingReason, nil] Billing reason
            #
            ...
            # Invoice status
            #
            # @see Stigg::Models::V1::Subscription::Data::LatestInvoice#status
            module Status
              extend Stigg::Internal::Type::Enum
            ...
            # Billing reason
            #
            # @see Stigg::Models::V1::Subscription::Data::LatestInvoice#billing_reason
          ...
          # @see Stigg::Models::V1::Subscription::Data#minimum_spend
          class MinimumSpend < Stigg::Internal::Type::BaseModel
            ...
            #   The price currency
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::MinimumSpend::Currency, nil]
            optional :currency, enum: -> { Stigg::V1::Subscription::Data::MinimumSpend::Currency }
            ...
            #   @param amount [Float] The price amount
            #
            #   @param currency [Symbol, Stigg::Models::V1::Subscription::Data::MinimumSpend::Currency] The price currency

            # The price currency
            #
            # @see Stigg::Models::V1::Subscription::Data::MinimumSpend#currency
            module Currency
              extend Stigg::Internal::Type::Enum
          ...
          class Price < Stigg::Internal::Type::BaseModel
            ...
            #   The price currency
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::Price::Currency, nil]
            optional :currency, enum: -> { Stigg::V1::Subscription::Data::Price::Currency }
            ...
            #
            #   @return [Array<Stigg::Models::V1::Subscription::Data::Price::Tier>, nil]
            optional :tiers, -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::Subscription::Data::Price::Tier] }
            ...
            #
            #   @param currency [Symbol, Stigg::Models::V1::Subscription::Data::Price::Currency] The price currency
            #
            #   @param feature_id [String, nil] Feature identifier for the price override
            #
            #   @param tiers [Array<Stigg::Models::V1::Subscription::Data::Price::Tier>] Pricing tiers configuration

            # The price currency
            #
            # @see Stigg::Models::V1::Subscription::Data::Price#currency
            module Currency
              extend Stigg::Internal::Type::Enum
            ...
            class Tier < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Stigg::Models::V1::Subscription::Data::Price::Tier::FlatPrice, nil]
              optional :flat_price,
                       -> {
              ...
              #
              #   @return [Stigg::Models::V1::Subscription::Data::Price::Tier::UnitPrice, nil]
              optional :unit_price,
                       -> {
              ...
              #   @param flat_price [Stigg::Models::V1::Subscription::Data::Price::Tier::FlatPrice] The flat fee price of the price tier
              #
              #   @param unit_price [Stigg::Models::V1::Subscription::Data::Price::Tier::UnitPrice] The unit price of the price tier
              #
              #   @param up_to [Float] The up to quantity of the price tier

              # @see Stigg::Models::V1::Subscription::Data::Price::Tier#flat_price
              class FlatPrice < Stigg::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Stigg::Models::V1::Subscription::Data::Price::Tier::FlatPrice::Currency]
                required :currency, enum: -> { Stigg::V1::Subscription::Data::Price::Tier::FlatPrice::Currency }
                ...
                #   @param amount [Float] The price amount
                #
                #   @param currency [Symbol, Stigg::Models::V1::Subscription::Data::Price::Tier::FlatPrice::Currency] ISO 4217 currency code

                # ISO 4217 currency code
                #
                # @see Stigg::Models::V1::Subscription::Data::Price::Tier::FlatPrice#currency
                module Currency
                  extend Stigg::Internal::Type::Enum
              ...
              # @see Stigg::Models::V1::Subscription::Data::Price::Tier#unit_price
              class UnitPrice < Stigg::Internal::Type::BaseModel
                ...
                #   ISO 4217 currency code
                #
                #   @return [Symbol, Stigg::Models::V1::Subscription::Data::Price::Tier::UnitPrice::Currency]
                required :currency, enum: -> { Stigg::V1::Subscription::Data::Price::Tier::UnitPrice::Currency }
                ...
                #   @param amount [Float] The price amount
                #
                #   @param currency [Symbol, Stigg::Models::V1::Subscription::Data::Price::Tier::UnitPrice::Currency] ISO 4217 currency code

                # ISO 4217 currency code
                #
                # @see Stigg::Models::V1::Subscription::Data::Price::Tier::UnitPrice#currency
                module Currency
                  extend Stigg::Internal::Type::Enum
          ...
          class SubscriptionEntitlement < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::SubscriptionEntitlement::Type]
            required :type, enum: -> { Stigg::V1::Subscription::Data::SubscriptionEntitlement::Type }
            ...
            #
            #   @param type [Symbol, Stigg::Models::V1::Subscription::Data::SubscriptionEntitlement::Type] Entitlement type (FEATURE or CREDIT)

            # Entitlement type (FEATURE or CREDIT)
            #
            # @see Stigg::Models::V1::Subscription::Data::SubscriptionEntitlement#type
            module Type
              extend Stigg::Internal::Type::Enum
          ...
          # @see Stigg::Models::V1::Subscription::Data#trial
          class Trial < Stigg::Internal::Type::BaseModel
            # @!attribute trial_end_behavior
            #   Behavior when the trial ends
            #
            #   @return [Symbol, Stigg::Models::V1::Subscription::Data::Trial::TrialEndBehavior]
            required :trial_end_behavior,
                     enum: -> { Stigg::V1::Subscription::Data::Trial::TrialEndBehavior },
                     api_name: :trialEndBehavior

            # @!method initialize(trial_end_behavior:)
            #   Trial configuration
            #
            #   @param trial_end_behavior [Symbol, Stigg::Models::V1::Subscription::Data::Trial::TrialEndBehavior] Behavior when the trial ends

            # Behavior when the trial ends
            #
            # @see Stigg::Models::V1::Subscription::Data::Trial#trial_end_behavior
