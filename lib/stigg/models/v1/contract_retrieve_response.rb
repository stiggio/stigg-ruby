...
module Stigg
  module Models
    module V1
      # @see Stigg::Resources::V1::Contracts#retrieve
      class ContractRetrieveResponse < Stigg::Internal::Type::BaseModel
        # @!attribute data
        #   A billing contract as reported by the connected billing provider.
        #
        #   @return [Stigg::Models::V1::ContractRetrieveResponse::Data]
        required :data, -> { Stigg::Models::V1::ContractRetrieveResponse::Data }

        # @!method initialize(data:)
        #   Response object
        #
        #   @param data [Stigg::Models::V1::ContractRetrieveResponse::Data] A billing contract as reported by the connected billing provider.

        # @see Stigg::Models::V1::ContractRetrieveResponse#data
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice, nil]
          ...
          #
          #   @return [Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice, nil]
          ...
          #   The current state of the contract
          #
          #   @return [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::State]
          ...
          #
          #   @return [Array<Stigg::Models::V1::ContractRetrieveResponse::Data::Subscription>]
          ...
          #
          #   @param latest_invoice [Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice, nil] The most recent non-draft invoice for this contract (open, paid, or canceled), o
          #
          #   @param name [String, nil] The contract name (the purchase-order number when set, otherwise the contract/cu
          #
          #   @param next_invoice [Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice, nil] A preview of the contract's upcoming invoice, or null when none is available
          #
          ...
          #
          #   @param state [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::State] The current state of the contract
          #
          ...
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            #   Invoice status
            #
            #   @return [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice::Status]
            required :status, enum: -> { Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice::Status }
            ...
            #   Billing reason
            #
            #   @return [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice::BillingReason, nil]
            optional :billing_reason,
                     enum: -> { Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice::BillingReason },
            ...
            #
            #   @param status [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice::Status] Invoice status
            #
            #   @param amount_due [Float, nil] Amount due
            #
            #   @param billing_reason [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice::BillingReason, nil] Billing reason
            #
            ...
            # Invoice status
            #
            # @see Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice#status
            module Status
              extend Stigg::Internal::Type::Enum
            ...
            # Billing reason
            #
            # @see Stigg::Models::V1::ContractRetrieveResponse::Data::LatestInvoice#billing_reason
          ...
          # @see Stigg::Models::V1::ContractRetrieveResponse::Data#next_invoice
          class NextInvoice < Stigg::Internal::Type::BaseModel
            # @!attribute amount
            #   The total amount of the upcoming invoice
            #
            #   @return [Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount]
            required :amount, -> { Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount }
            ...
            #   A preview of the contract's upcoming invoice, or null when none is available
            #
            #   @param amount [Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount] The total amount of the upcoming invoice
            #
            ...
            # @see Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice#amount
            class Amount < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount::Currency]
              required :currency,
                       enum: -> { Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount::Currency }
              ...
              #
              #   @param currency [Symbol, Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount::Currency] ISO 4217 currency code

              # ISO 4217 currency code
              #
              # @see Stigg::Models::V1::ContractRetrieveResponse::Data::NextInvoice::Amount#currency
              module Currency
                extend Stigg::Internal::Type::Enum
          ...
          # The current state of the contract
          #
          # @see Stigg::Models::V1::ContractRetrieveResponse::Data#state
          module State
            extend Stigg::Internal::Type::Enum
