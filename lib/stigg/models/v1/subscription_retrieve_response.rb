  ...
  module Models
    module V1
      ...
      class SubscriptionRetrieveResponse < Stigg::Internal::Type::BaseModel
        ...
        #   @param data [Stigg::Models::V1::SubscriptionRetrieveResponse::Data]
        ...
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #   Payment collection
          #
          #   @return [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PaymentCollection]
          required :payment_collection,
                   enum: -> { Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PaymentCollection },
          ...
          #   Pricing type
          #
          #   @return [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PricingType]
          required :pricing_type,
                   enum: -> { Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PricingType },
          ...
          #   Subscription status
          #
          #   @return [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::Status]
          required :status, enum: -> { Stigg::Models::V1::SubscriptionRetrieveResponse::Data::Status }
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::CancelReason, nil]
          optional :cancel_reason,
                   enum: -> { Stigg::Models::V1::SubscriptionRetrieveResponse::Data::CancelReason },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PaymentCollectionMethod, nil]
          optional :payment_collection_method,
                   enum: -> { Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PaymentCollectionMethod },
          ...
          #
          #   @param payment_collection [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PaymentCollection] Payment collection
          #
          #   @param plan_id [String] Plan ID
          #
          #   @param pricing_type [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::PricingType] Pricing type
          #
          #   @param start_date [Time] Subscription start date
          #
          #   @param status [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::Status] Subscription status
          #
          #   @param cancellation_date [Time, nil] Subscription cancellation date
          #
          #   @param cancel_reason [Symbol, Stigg::Models::V1::SubscriptionRetrieveResponse::Data::CancelReason, nil] Subscription cancel reason
          #
          ...
          # Payment collection
          #
          # @see Stigg::Models::V1::SubscriptionRetrieveResponse::Data#payment_collection
          ...
          # Pricing type
          #
          # @see Stigg::Models::V1::SubscriptionRetrieveResponse::Data#pricing_type
          module PricingType
            extend Stigg::Internal::Type::Enum
          ...
          # Subscription status
          #
          # @see Stigg::Models::V1::SubscriptionRetrieveResponse::Data#status
          module Status
            extend Stigg::Internal::Type::Enum
          ...
          # Subscription cancel reason
          #
          # @see Stigg::Models::V1::SubscriptionRetrieveResponse::Data#cancel_reason
          module CancelReason
            extend Stigg::Internal::Type::Enum
          ...
          # The method used to collect payments for a subscription
          #
          # @see Stigg::Models::V1::SubscriptionRetrieveResponse::Data#payment_collection_method
