  ...
  module Models
    module V1
      class ChargeList < Stigg::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Stigg::Models::V1::ChargeList::Data>]
        required :data, -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::ChargeList::Data] }

        # @!attribute pagination
        #   Pagination metadata including cursors for navigating through results
        #
        #   @return [Stigg::Models::V1::ChargeList::Pagination]
        required :pagination, -> { Stigg::V1::ChargeList::Pagination }

        # @!method initialize(data:, pagination:)
        #   Response list object
        #
        #   @param data [Array<Stigg::Models::V1::ChargeList::Data>]
        #
        #   @param pagination [Stigg::Models::V1::ChargeList::Pagination] Pagination metadata including cursors for navigating through results
        ...
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::BillingCadence]
          required :billing_cadence,
                   enum: -> { Stigg::V1::ChargeList::Data::BillingCadence },
                   api_name: :billingCadence

          # @!attribute billing_model
          #   The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
          #
          #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::BillingModel]
          required :billing_model,
                   enum: -> {
                     Stigg::V1::ChargeList::Data::BillingModel
                   },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::BillingPeriod]
          required :billing_period,
                   enum: -> { Stigg::V1::ChargeList::Data::BillingPeriod },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::CreditGrantCadence, nil]
          optional :credit_grant_cadence,
                   enum: -> { Stigg::V1::ChargeList::Data::CreditGrantCadence },
          ...
          #
          #   @return [Stigg::Models::V1::ChargeList::Data::CreditRate, nil]
          ...
          #
          #   @return [Stigg::Models::V1::ChargeList::Data::Price, nil]
          optional :price, -> { Stigg::V1::ChargeList::Data::Price }, nil?: true

          # @!attribute tiers
          #   Tiered pricing rows when the charge is tiered
          #
          #   @return [Array<Stigg::Models::V1::ChargeList::Data::Tier>, nil]
          optional :tiers,
                   -> {
                     Stigg::Internal::Type::ArrayOf[Stigg::V1::ChargeList::Data::Tier]
                   },
                   nil?: true
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::TiersMode, nil]
          optional :tiers_mode,
                   enum: -> { Stigg::V1::ChargeList::Data::TiersMode },
                   api_name: :tiersMode,
                   nil?: true
          ...
          #   {Stigg::Models::V1::ChargeList::Data} for more details.
          #
          ...
          #
          #   @param billing_cadence [Symbol, Stigg::Models::V1::ChargeList::Data::BillingCadence] The billing cadence (RECURRING or ONE_OFF)
          #
          #   @param billing_model [Symbol, Stigg::Models::V1::ChargeList::Data::BillingModel] The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
          #
          #   @param billing_period [Symbol, Stigg::Models::V1::ChargeList::Data::BillingPeriod] The billing period (MONTHLY or ANNUALLY)
          #
          ...
          #
          #   @param credit_grant_cadence [Symbol, Stigg::Models::V1::ChargeList::Data::CreditGrantCadence, nil] When credits are granted (for credit-based pricing)
          #
          #   @param credit_rate [Stigg::Models::V1::ChargeList::Data::CreditRate, nil] Credit rate configuration for credit-based pricing
          #
          ...
          #
          #   @param price [Stigg::Models::V1::ChargeList::Data::Price, nil] The flat price amount and currency, when applicable
          #
          #   @param tiers [Array<Stigg::Models::V1::ChargeList::Data::Tier>, nil] Tiered pricing rows when the charge is tiered
          #
          #   @param tiers_mode [Symbol, Stigg::Models::V1::ChargeList::Data::TiersMode, nil] Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
          #
          ...
          # The billing cadence (RECURRING or ONE_OFF)
          #
          # @see Stigg::Models::V1::ChargeList::Data#billing_cadence
          ...
          # The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
          #
          # @see Stigg::Models::V1::ChargeList::Data#billing_model
          module BillingModel
            extend Stigg::Internal::Type::Enum
          ...
          # The billing period (MONTHLY or ANNUALLY)
          #
          # @see Stigg::Models::V1::ChargeList::Data#billing_period
          ...
          # When credits are granted (for credit-based pricing)
          #
          # @see Stigg::Models::V1::ChargeList::Data#credit_grant_cadence
          ...
          # @see Stigg::Models::V1::ChargeList::Data#credit_rate
          ...
          # @see Stigg::Models::V1::ChargeList::Data#price
          class Price < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::Price::Currency]
            required :currency, enum: -> { Stigg::V1::ChargeList::Data::Price::Currency }
            ...
            #
            #   @param currency [Symbol, Stigg::Models::V1::ChargeList::Data::Price::Currency] ISO 4217 currency code

            # ISO 4217 currency code
            #
            # @see Stigg::Models::V1::ChargeList::Data::Price#currency
            module Currency
              extend Stigg::Internal::Type::Enum
          ...
          class Tier < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Stigg::Models::V1::ChargeList::Data::Tier::FlatPrice, nil]
            optional :flat_price,
            ...
            #
            #   @return [Stigg::Models::V1::ChargeList::Data::Tier::UnitPrice, nil]
            optional :unit_price,
            ...
            #
            #   @param flat_price [Stigg::Models::V1::ChargeList::Data::Tier::FlatPrice, nil] Flat price for this tier
            #
            #   @param unit_price [Stigg::Models::V1::ChargeList::Data::Tier::UnitPrice, nil] Per-unit price in this tier
            #
            #   @param up_to [Float, nil] Upper bound of this tier (null for unlimited)

            # @see Stigg::Models::V1::ChargeList::Data::Tier#flat_price
            class FlatPrice < Stigg::Internal::Type::BaseModel
              ...
              #   ISO 4217 currency code
              #
              #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::Tier::FlatPrice::Currency]
              required :currency, enum: -> { Stigg::V1::ChargeList::Data::Tier::FlatPrice::Currency }
              ...
              #   @param amount [Float] The price amount
              #
              #   @param currency [Symbol, Stigg::Models::V1::ChargeList::Data::Tier::FlatPrice::Currency] ISO 4217 currency code

              # ISO 4217 currency code
              #
              # @see Stigg::Models::V1::ChargeList::Data::Tier::FlatPrice#currency
              module Currency
                extend Stigg::Internal::Type::Enum
            ...
            # @see Stigg::Models::V1::ChargeList::Data::Tier#unit_price
            class UnitPrice < Stigg::Internal::Type::BaseModel
              ...
              #   ISO 4217 currency code
              #
              #   @return [Symbol, Stigg::Models::V1::ChargeList::Data::Tier::UnitPrice::Currency]
              required :currency, enum: -> { Stigg::V1::ChargeList::Data::Tier::UnitPrice::Currency }
              ...
              #   @param amount [Float] The price amount
              #
              #   @param currency [Symbol, Stigg::Models::V1::ChargeList::Data::Tier::UnitPrice::Currency] ISO 4217 currency code

              # ISO 4217 currency code
              #
              # @see Stigg::Models::V1::ChargeList::Data::Tier::UnitPrice#currency
              module Currency
                extend Stigg::Internal::Type::Enum
          ...
          # Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
          #
          # @see Stigg::Models::V1::ChargeList::Data#tiers_mode
          module TiersMode
            extend Stigg::Internal::Type::Enum
        ...
        # @see Stigg::Models::V1::ChargeList#pagination
        class Pagination < Stigg::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Stigg::Models::V1::ChargeList::Pagination} for more details.
          #
          #   Pagination metadata including cursors for navigating through results
          #
