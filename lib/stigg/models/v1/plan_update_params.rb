  ...
  module Models
    module V1
      ...
      class PlanUpdateParams < Stigg::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, billing_id: nil, charges: nil, compatible_addon_ids: nil, default_trial_config: nil, description: nil, display_name: nil, metadata: nil, parent_plan_id: nil, request_options: {})
        #   @param id [String]
        #
