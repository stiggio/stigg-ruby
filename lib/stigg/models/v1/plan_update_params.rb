...
module Stigg
  module Models
    module V1
      # @see Stigg::Resources::V1::Plans#update
      class PlanUpdateParams < Stigg::Internal::Type::BaseModel
        ...
        class Charges < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingType]
          required :pricing_type,
                   enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingType },
          ...
          #
          #   @return [Array<Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend>, nil]
          optional :minimum_spend,
                   -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::PlanUpdateParams::Charges::MinimumSpend] },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OverageBillingPeriod, nil]
          optional :overage_billing_period,
                   enum: -> { Stigg::V1::PlanUpdateParams::Charges::OverageBillingPeriod },
          ...
          optional :overage_pricing_models,
                   -> {
                     Stigg::Internal::Type::ArrayOf[Stigg::V1::PlanUpdateParams::Charges::OveragePricingModel]
                   },
          ...
          optional :pricing_models,
                   -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::PlanUpdateParams::Charges::PricingModel] },
          ...
          #
          #   @param minimum_spend [Array<Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend>, nil] Minimum spend configuration per billing period
          #
          ...
          # The pricing type (FREE, PAID, or CUSTOM)
          #
          # @see Stigg::Models::V1::PlanUpdateParams::Charges#pricing_type
          module PricingType
          ...
          class MinimumSpend < Stigg::Internal::Type::BaseModel
            ...
            #   The billing period
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::BillingPeriod]
            required :billing_period,
                     enum: -> { Stigg::V1::PlanUpdateParams::Charges::MinimumSpend::BillingPeriod },
                     api_name: :billingPeriod

            # @!attribute minimum
            #   The minimum spend amount
            #
            #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum]
            required :minimum, -> { Stigg::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum }

            # @!method initialize(billing_period:, minimum:)
            #   Minimum spend configuration for a billing period.
            #
            #   @param billing_period [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::BillingPeriod] The billing period
            #
            #   @param minimum [Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum] The minimum spend amount

            # The billing period
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend#billing_period
            ...
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend#minimum
            class Minimum < Stigg::Internal::Type::BaseModel
              ...
              #   The price currency
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum::Currency, nil]
              optional :currency, enum: -> { Stigg::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum::Currency }
              ...
              #
              #   @param currency [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum::Currency] The price currency

              # The price currency
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::MinimumSpend::Minimum#currency
              module Currency
                extend Stigg::Internal::Type::Enum
          ...
          # When overage charges are billed
          #
          # @see Stigg::Models::V1::PlanUpdateParams::Charges#overage_billing_period
          ...
          class OveragePricingModel < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::BillingModel]
            ...
            #
            #   @return [Array<Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::PricePeriod>]
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::BillingCadence, nil]
            ...
            #   granted on the plan
            #
            #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::CreditEntitlement, nil]
            ...
            #
            #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement, nil]
            ...
            #   {Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel} for more
            #   details.
            #
            ...
            #
            #   @param price_periods [Array<Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::PricePeriod>] Price periods for overage pricing
            #
            ...
            #
            #   @param credit_entitlement [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::CreditEntitlement] Credit entitlement to grant when a credit overage targets a currency not yet gra
            #
            ...
            # The billing model for overages
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel#billing_model
            module BillingModel
              extend Stigg::Internal::Type::Enum
            ...
            # The billing cadence for overages
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel#billing_cadence
            ...
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel#credit_entitlement
            class CreditEntitlement < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::CreditEntitlement::Cadence]
              required :cadence,
              ...
              #
              #   @param cadence [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::CreditEntitlement::Cadence] The credit grant cadence (MONTH or YEAR)
              #
              #   @param custom_currency_id [String] The refId of the custom currency to grant

              # The credit grant cadence (MONTH or YEAR)
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::CreditEntitlement#cadence
              module Cadence
                extend Stigg::Internal::Type::Enum
            ...
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel#entitlement
            class Entitlement < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::MonthlyResetPeriodConfiguration, nil]
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::ResetPeriod, nil]
              ...
              #
              #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::WeeklyResetPeriodConfiguration, nil]
              ...
              #
              #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::YearlyResetPeriodConfiguration, nil]
              ...
              #
              #   @param monthly_reset_period_configuration [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::MonthlyResetPeriodConfiguration] Monthly reset configuration
              #
              #   @param reset_period [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::ResetPeriod] The usage reset period
              #
              #   @param usage_limit [Float] The usage limit before overage kicks in
              #
              #   @param weekly_reset_period_configuration [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::WeeklyResetPeriodConfiguration] Weekly reset configuration
              #
              #   @param yearly_reset_period_configuration [Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::YearlyResetPeriodConfiguration] Yearly reset configuration

              # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement#monthly_reset_period_configuration
              class MonthlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                # @!attribute according_to
                #   Reset anchor (SubscriptionStart or StartOfTheMonth)
                #
                #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::MonthlyResetPeriodConfiguration::AccordingTo]
                required :according_to,
                         enum: -> {
                           Stigg::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::MonthlyResetPeriodConfiguration::AccordingTo
                         },
                ...
                #   Monthly reset configuration
                #
                #   @param according_to [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::MonthlyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart or StartOfTheMonth)

                # Reset anchor (SubscriptionStart or StartOfTheMonth)
                #
                # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::MonthlyResetPeriodConfiguration#according_to
                module AccordingTo
                  extend Stigg::Internal::Type::Enum
              ...
              # The usage reset period
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement#reset_period
              module ResetPeriod
                extend Stigg::Internal::Type::Enum
              ...
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement#weekly_reset_period_configuration
              class WeeklyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                # @!attribute according_to
                #   Reset anchor (SubscriptionStart or specific day)
                #
                #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::WeeklyResetPeriodConfiguration::AccordingTo]
                required :according_to,
                         enum: -> {
                           Stigg::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::WeeklyResetPeriodConfiguration::AccordingTo
                         },
                         api_name: :accordingTo
                ...
                #   Weekly reset configuration
                #
                #   @param according_to [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::WeeklyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart or specific day)

                # Reset anchor (SubscriptionStart or specific day)
                #
                # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::WeeklyResetPeriodConfiguration#according_to
                module AccordingTo
                  extend Stigg::Internal::Type::Enum
              ...
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement#yearly_reset_period_configuration
              class YearlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
                # @!attribute according_to
                #   Reset anchor (SubscriptionStart)
                #
                #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::YearlyResetPeriodConfiguration::AccordingTo]
                required :according_to,
                         enum: -> {
                           Stigg::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::YearlyResetPeriodConfiguration::AccordingTo
                         },
                         api_name: :accordingTo
                ...
                #   Yearly reset configuration
                #
                #   @param according_to [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::YearlyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart)

                # Reset anchor (SubscriptionStart)
                #
                # @see Stigg::Models::V1::PlanUpdateParams::Charges::OveragePricingModel::Entitlement::YearlyResetPeriodConfiguration#according_to
                module AccordingTo
                  extend Stigg::Internal::Type::Enum
          ...
          class PricingModel < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::BillingModel]
            required :billing_model,
                     enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::BillingModel },
                     api_name: :billingModel

            # @!attribute price_periods
            #   Array of price period configurations (at least one required)
            #
            #   @return [Array<Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod>]
            required :price_periods,
                     -> {
                       Stigg::Internal::Type::ArrayOf[Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod]
                     },
                     api_name: :pricePeriods
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::BillingCadence, nil]
            optional :billing_cadence,
                     enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::BillingCadence },
                     api_name: :billingCadence
            ...
            #
            #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration, nil]
            optional :monthly_reset_period_configuration,
                     -> {
                       Stigg::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration
                     },
                     api_name: :monthlyResetPeriodConfiguration
            ...
            #   The usage reset period
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::ResetPeriod, nil]
            optional :reset_period,
                     enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::ResetPeriod },
                     api_name: :resetPeriod

            # @!attribute tiers_mode
            #   The tiered pricing mode (VOLUME or GRADUATED)
            #
            #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::TiersMode, nil]
            optional :tiers_mode,
                     enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::TiersMode },
                     api_name: :tiersMode
            ...
            #
            #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration, nil]
            optional :weekly_reset_period_configuration,
                     -> {
                       Stigg::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration
                     },
                     api_name: :weeklyResetPeriodConfiguration
            ...
            #
            #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration, nil]
            optional :yearly_reset_period_configuration,
                     -> {
                       Stigg::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration
                     },
                     api_name: :yearlyResetPeriodConfiguration
            ...
            #
            #   @param billing_model [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::BillingModel] The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED)
            #
            #   @param price_periods [Array<Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod>] Array of price period configurations (at least one required)
            #
            #   @param billing_cadence [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::BillingCadence] The billing cadence (RECURRING or ONE_OFF)
            #
            ...
            #
            #   @param monthly_reset_period_configuration [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration] Monthly reset period configuration
            #
            #   @param reset_period [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::ResetPeriod] The usage reset period
            #
            #   @param tiers_mode [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::TiersMode] The tiered pricing mode (VOLUME or GRADUATED)
            #
            #   @param top_up_custom_currency_id [String] The custom currency ID for top-up pricing
            #
            #   @param weekly_reset_period_configuration [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration] Weekly reset period configuration
            #
            #   @param yearly_reset_period_configuration [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration] Yearly reset period configuration

            # The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED)
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#billing_model
            module BillingModel
              extend Stigg::Internal::Type::Enum
            ...
            class PricePeriod < Stigg::Internal::Type::BaseModel
              ...
              #   The billing period (MONTHLY or ANNUALLY)
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::BillingPeriod]
              required :billing_period,
                       enum: -> {
                         Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::BillingPeriod
                       },
                       api_name: :billingPeriod
              ...
              #   When credits are granted
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::CreditGrantCadence, nil]
              optional :credit_grant_cadence,
                       enum: -> {
                         Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::CreditGrantCadence
                       },
                       api_name: :creditGrantCadence
              ...
              #   Credit rate configuration for credit-based pricing
              #
              #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::CreditRate, nil]
              optional :credit_rate,
                       -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::CreditRate },
                       api_name: :creditRate

              # @!attribute price
              #   The price amount and currency
              #
              #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price, nil]
              optional :price, -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price }

              # @!attribute tiers
              #   Tiered pricing configuration
              #
              #   @return [Array<Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier>, nil]
              optional :tiers,
              ...
              #   @param block_size [Float] Block size for usage-based pricing
              #
              #   @param credit_grant_cadence [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::CreditGrantCadence] When credits are granted
              #
              #   @param credit_rate [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::CreditRate] Credit rate configuration for credit-based pricing
              #
              #   @param price [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price] The price amount and currency
              #
              #   @param tiers [Array<Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier>] Tiered pricing configuration

              # The billing period (MONTHLY or ANNUALLY)
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod#billing_period
              module BillingPeriod
                extend Stigg::Internal::Type::Enum
              ...
              # When credits are granted
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod#credit_grant_cadence
              module CreditGrantCadence
                extend Stigg::Internal::Type::Enum
              ...
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod#credit_rate
              class CreditRate < Stigg::Internal::Type::BaseModel
                # @!attribute amount
                #   The credit rate amount
                #
              ...
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod#price
              class Price < Stigg::Internal::Type::BaseModel
                # @!attribute amount
                #   The price amount
                #
                ...
                #   The price currency
                #
                #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price::Currency, nil]
                optional :currency,
                         enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price::Currency }
                ...
                #   @param amount [Float] The price amount
                #
                #   @param currency [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price::Currency] The price currency

                # The price currency
                #
                # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Price#currency
                module Currency
                  extend Stigg::Internal::Type::Enum
              ...
              class Tier < Stigg::Internal::Type::BaseModel
                ...
                #   Flat price for this tier
                #
                #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice, nil]
                optional :flat_price,
                         -> {
                           Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice
                         },
                         api_name: :flatPrice
                ...
                #   Per-unit price in this tier
                #
                #   @return [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice, nil]
                optional :unit_price,
                         -> {
                           Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice
                         },
                         api_name: :unitPrice
                ...
                #   A tier in tiered pricing.
                #
                #   @param flat_price [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice] Flat price for this tier
                #
                #   @param unit_price [Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice] Per-unit price in this tier
                #
                #   @param up_to [Float] Upper bound of this tier (null for unlimited)

                # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier#flat_price
                class FlatPrice < Stigg::Internal::Type::BaseModel
                  # @!attribute amount
                  #   The price amount
                  #
                  ...
                  #   The price currency
                  #
                  #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice::Currency, nil]
                  optional :currency,
                           enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice::Currency }
                  ...
                  #   @param amount [Float] The price amount
                  #
                  #   @param currency [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice::Currency] The price currency

                  # The price currency
                  #
                  # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::FlatPrice#currency
                  module Currency
                    extend Stigg::Internal::Type::Enum
                ...
                # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier#unit_price
                class UnitPrice < Stigg::Internal::Type::BaseModel
                  # @!attribute amount
                  #   The price amount
                  #
                  ...
                  #   The price currency
                  #
                  #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice::Currency, nil]
                  optional :currency,
                           enum: -> { Stigg::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice::Currency }
                  ...
                  #   @param amount [Float] The price amount
                  #
                  #   @param currency [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice::Currency] The price currency

                  # The price currency
                  #
                  # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::PricePeriod::Tier::UnitPrice#currency
                  module Currency
                    extend Stigg::Internal::Type::Enum
            ...
            # The billing cadence (RECURRING or ONE_OFF)
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#billing_cadence
            module BillingCadence
              extend Stigg::Internal::Type::Enum
            ...
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#monthly_reset_period_configuration
            class MonthlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
              # @!attribute according_to
              #   Reset anchor (SubscriptionStart or StartOfTheMonth)
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration::AccordingTo]
              required :according_to,
                       enum: -> {
                         Stigg::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration::AccordingTo
                       },
                       api_name: :accordingTo
              ...
              #   Monthly reset period configuration
              #
              #   @param according_to [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart or StartOfTheMonth)

              # Reset anchor (SubscriptionStart or StartOfTheMonth)
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::MonthlyResetPeriodConfiguration#according_to
              module AccordingTo
                extend Stigg::Internal::Type::Enum
            ...
            # The usage reset period
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#reset_period
            module ResetPeriod
              extend Stigg::Internal::Type::Enum
            ...
            # The tiered pricing mode (VOLUME or GRADUATED)
            #
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#tiers_mode
            module TiersMode
              extend Stigg::Internal::Type::Enum
            ...
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#weekly_reset_period_configuration
            class WeeklyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
              # @!attribute according_to
              #   Reset anchor (SubscriptionStart or specific day)
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration::AccordingTo]
              required :according_to,
                       enum: -> {
                         Stigg::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration::AccordingTo
                       },
                       api_name: :accordingTo
              ...
              #   Weekly reset period configuration
              #
              #   @param according_to [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart or specific day)

              # Reset anchor (SubscriptionStart or specific day)
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::WeeklyResetPeriodConfiguration#according_to
              module AccordingTo
                extend Stigg::Internal::Type::Enum
            ...
            # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel#yearly_reset_period_configuration
            class YearlyResetPeriodConfiguration < Stigg::Internal::Type::BaseModel
              # @!attribute according_to
              #   Reset anchor (SubscriptionStart)
              #
              #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration::AccordingTo]
              required :according_to,
                       enum: -> {
                         Stigg::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration::AccordingTo
                       },
                       api_name: :accordingTo
              ...
              #   Yearly reset period configuration
              #
              #   @param according_to [Symbol, Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration::AccordingTo] Reset anchor (SubscriptionStart)

              # Reset anchor (SubscriptionStart)
              #
              # @see Stigg::Models::V1::PlanUpdateParams::Charges::PricingModel::YearlyResetPeriodConfiguration#according_to
              module AccordingTo
                extend Stigg::Internal::Type::Enum
        ...
        class DefaultTrialConfig < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig::Units]
          required :units, enum: -> { Stigg::V1::PlanUpdateParams::DefaultTrialConfig::Units }

          # @!attribute budget
          #   Budget configuration for the trial
          #
          #   @return [Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig::Budget, nil]
          optional :budget, -> { Stigg::V1::PlanUpdateParams::DefaultTrialConfig::Budget }, nil?: true

          # @!attribute trial_end_behavior
          #   Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)
          #
          #   @return [Symbol, Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig::TrialEndBehavior, nil]
          optional :trial_end_behavior,
                   enum: -> { Stigg::V1::PlanUpdateParams::DefaultTrialConfig::TrialEndBehavior },
          ...
          #
          #   @param units [Symbol, Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig::Units] The time unit for the trial duration (DAY or MONTH)
          #
          #   @param budget [Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig::Budget, nil] Budget configuration for the trial
          #
          #   @param trial_end_behavior [Symbol, Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig::TrialEndBehavior, nil] Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)

          # The time unit for the trial duration (DAY or MONTH)
          #
          # @see Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig#units
          module Units
            extend Stigg::Internal::Type::Enum
          ...
          # @see Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig#budget
          ...
          # Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)
          #
          # @see Stigg::Models::V1::PlanUpdateParams::DefaultTrialConfig#trial_end_behavior
