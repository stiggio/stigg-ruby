    ...
    module V1
      module Plans
        ...
        class EntitlementCreateParams < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement>]
          required :entitlements,
                   -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::Plans::EntitlementCreateParams::Entitlement] }

          # @!method initialize(plan_id:, entitlements:, request_options: {})
          #   @param plan_id [String]
          #
          #   @param entitlements [Array<Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement>] Entitlements to create
          #
          ...
          class Entitlement < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement::Credit, nil]
            optional :credit, -> { Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Credit }

            # @!attribute feature
            #   Feature entitlement to create
            #
            #   @return [Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement::Feature, nil]
            optional :feature, -> { Stigg::V1::Plans::EntitlementCreateParams::Entitlement::Feature }

            # @!method initialize(credit: nil, feature: nil)
            #   A single entitlement to create. Provide exactly one of feature or credit.
            #
            #   @param credit [Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement::Credit] Credit entitlement to create
            #
            #   @param feature [Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement::Feature] Feature entitlement to create

            # @see Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement#credit
            ...
            # @see Stigg::Models::V1::Plans::EntitlementCreateParams::Entitlement#feature
