      ...
      module Customers
        ...
        class IntegrationListResponse < Stigg::Internal::Type::BaseModel
          ...
          required :vendor_identifier,
                   enum: -> { Stigg::Models::V1::Customers::IntegrationListResponse::VendorIdentifier },
          ...
          #
          #   @return [Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionPriceBillingData, Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionBillingData, Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionMarketplaceData, nil]
          optional :sync_data,
                   union: -> { Stigg::Models::V1::Customers::IntegrationListResponse::SyncData },
                   api_name: :syncData,
                   nil?: true
          ...
          # group package billing ID
          #
          # @see Stigg::Models::V1::Customers::IntegrationListResponse#sync_data
          module SyncData
            extend Stigg::Internal::Type::Union

            # Price billing sync revision data containing billing ID, link URL, and price group package billing ID
            variant -> { Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionPriceBillingData }

            # Billing sync revision data containing billing ID and link URL
            variant -> { Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionBillingData }

            # Marketplace sync revision data containing dimensions
            variant -> { Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionMarketplaceData }
            ...
            #   @return [Array(Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionPriceBillingData, Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionBillingData, Stigg::Models::V1::Customers::IntegrationListResponse::SyncData::SyncRevisionMarketplaceData)]
          end
        end
      end
    end
