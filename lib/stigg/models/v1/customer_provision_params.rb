  ...
  module Models
    module V1
      ...
      class CustomerProvisionParams < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [String, Symbol, Stigg::Models::V1::CustomerProvisionParams::CouponID, nil]
        optional :coupon_id,
                 union: -> { Stigg::V1::CustomerProvisionParams::CouponID },
                 api_name: :couponId,
                 nil?: true
        ...
        #
        #   @return [Stigg::Models::V1::CustomerProvisionParams::Passthrough, nil]
        optional :passthrough, -> { Stigg::V1::CustomerProvisionParams::Passthrough }
        ...
        # @!method initialize(id:, billing_currency: nil, billing_id: nil, coupon_id: nil, default_payment_method: nil, email: nil, integrations: nil, language: nil, metadata: nil, name: nil, passthrough: nil, timezone: nil, request_options: {})
        ...
        module CouponID
          ...
          variant const: -> { Stigg::Models::V1::CustomerProvisionParams::CouponID::EMPTY }

          # @!method self.variants
          #   @return [Array(String, Symbol)]

          define_sorbet_constant!(:Variants) do
            T.type_alias { T.any(String, Stigg::V1::CustomerProvisionParams::CouponID::TaggedSymbol) }
          end
        ...
        class Passthrough < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe, nil]
          optional :stripe, -> { Stigg::V1::CustomerProvisionParams::Passthrough::Stripe }

          # @!attribute zuora
          #   Zuora-specific billing fields for the customer.
          #
          #   @return [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Zuora, nil]
          optional :zuora, -> { Stigg::V1::CustomerProvisionParams::Passthrough::Zuora }

          # @!method initialize(stripe: nil, zuora: nil)
          #   Vendor-specific billing passthrough fields.
          #
          #   @param stripe [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe] Stripe-specific billing fields for the customer.
          #
          #   @param zuora [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Zuora] Zuora-specific billing fields for the customer.

          # @see Stigg::Models::V1::CustomerProvisionParams::Passthrough#stripe
          class Stripe < Stigg::Internal::Type::BaseModel
            # @!attribute billing_address
            #   Physical address
            #
            #   @return [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe::BillingAddress, nil]
            optional :billing_address,
                     -> { Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::BillingAddress },
            ...
            #   Physical address
            #
            #   @return [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe::ShippingAddress, nil]
            optional :shipping_address,
                     -> { Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::ShippingAddress },
                     api_name: :shippingAddress

            # @!attribute tax_ids
            #   Tax IDs
            #
            #   @return [Array<Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe::TaxID>, nil]
            optional :tax_ids,
                     -> {
                       Stigg::Internal::Type::ArrayOf[Stigg::V1::CustomerProvisionParams::Passthrough::Stripe::TaxID]
                     },
                     api_name: :taxIds
            ...
            #
            #   @param shipping_address [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe::ShippingAddress] Physical address
            #
            #   @param tax_ids [Array<Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe::TaxID>] Tax IDs

            # @see Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe#billing_address
            ...
            # @see Stigg::Models::V1::CustomerProvisionParams::Passthrough::Stripe#shipping_address
          ...
          # @see Stigg::Models::V1::CustomerProvisionParams::Passthrough#zuora
          class Zuora < Stigg::Internal::Type::BaseModel
            # @!attribute billing_address
            #   Physical address
            #
            #   @return [Stigg::Models::V1::CustomerProvisionParams::Passthrough::Zuora::BillingAddress, nil]
            optional :billing_address,
                     -> { Stigg::V1::CustomerProvisionParams::Passthrough::Zuora::BillingAddress },
                     api_name: :billingAddress

            # @!attribute currency
            #   Customers selected currency
            #
            #   @return [Symbol, Stigg::Models::V1::CustomerProvisionParams::Passthrough::Zuora::Currency, nil]
            ...
            # @see Stigg::Models::V1::CustomerProvisionParams::Passthrough::Zuora#billing_address
            class BillingAddress < Stigg::Internal::Type::BaseModel
              # @!attribute city
              #   City name
              #
            ...
            # Customers selected currency
            #
            # @see Stigg::Models::V1::CustomerProvisionParams::Passthrough::Zuora#currency
            module Currency
              extend Stigg::Internal::Type::Enum
