  ...
  module Models
    module V1
      ...
      class CustomerListResponse < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [String, Symbol, Stigg::Models::V1::CustomerListResponse::CouponID, nil]
        optional :coupon_id,
                 union: -> { Stigg::Models::V1::CustomerListResponse::CouponID },
                 api_name: :couponId,
                 nil?: true
        ...
        #
        #   @return [Stigg::Models::V1::CustomerListResponse::Passthrough, nil]
        optional :passthrough, -> { Stigg::Models::V1::CustomerListResponse::Passthrough }
        ...
        #
        #   @param coupon_id [String, Symbol, Stigg::Models::V1::CustomerListResponse::CouponID, nil] Customer level coupon
        #
        ...
        #
        #   @param passthrough [Stigg::Models::V1::CustomerListResponse::Passthrough] Vendor-specific billing passthrough fields.
        #
        ...
        # Customer level coupon
        #
        # @see Stigg::Models::V1::CustomerListResponse#coupon_id
        module CouponID
          ...
          variant const: -> { Stigg::Models::V1::CustomerListResponse::CouponID::EMPTY }

          # @!method self.variants
          #   @return [Array(String, Symbol)]

          define_sorbet_constant!(:Variants) do
            T.type_alias { T.any(String, Stigg::Models::V1::CustomerListResponse::CouponID::TaggedSymbol) }
          end
        ...
        # @see Stigg::Models::V1::CustomerListResponse#passthrough
        class Passthrough < Stigg::Internal::Type::BaseModel
          # @!attribute stripe
          #   Stripe-specific billing fields for the customer.
          #
          #   @return [Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe, nil]
          optional :stripe, -> { Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe }

          # @!attribute zuora
          #   Zuora-specific billing fields for the customer.
          #
          #   @return [Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora, nil]
          optional :zuora, -> { Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora }

          # @!method initialize(stripe: nil, zuora: nil)
          #   Vendor-specific billing passthrough fields.
          #
          #   @param stripe [Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe] Stripe-specific billing fields for the customer.
          #
          #   @param zuora [Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora] Zuora-specific billing fields for the customer.

          # @see Stigg::Models::V1::CustomerListResponse::Passthrough#stripe
          class Stripe < Stigg::Internal::Type::BaseModel
            # @!attribute billing_address
            #   Physical address
            #
            #   @return [Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe::BillingAddress, nil]
            ...
            #   Physical address
            #
            #   @return [Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe::ShippingAddress, nil]
            ...
            #   Tax IDs
            #
            #   @return [Array<Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe::TaxID>, nil]
            optional :tax_ids,
            ...
            #   Stripe-specific billing fields for the customer.
            #
            #   @param billing_address [Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe::BillingAddress] Physical address
            #
            ...
            #
            #   @param shipping_address [Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe::ShippingAddress] Physical address
            #
            #   @param tax_ids [Array<Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe::TaxID>] Tax IDs

            # @see Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe#billing_address
            ...
            # @see Stigg::Models::V1::CustomerListResponse::Passthrough::Stripe#shipping_address
          ...
          # @see Stigg::Models::V1::CustomerListResponse::Passthrough#zuora
          class Zuora < Stigg::Internal::Type::BaseModel
            # @!attribute billing_address
            #   Physical address
            #
            #   @return [Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora::BillingAddress, nil]
            optional :billing_address,
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora::Currency, nil]
            optional :currency, enum: -> { Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora::Currency }
            ...
            #   Zuora-specific billing fields for the customer.
            #
            #   @param billing_address [Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora::BillingAddress] Physical address
            #
            #   @param currency [Symbol, Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora::Currency] Customers selected currency
            #
            #   @param metadata [Hash{Symbol=>String}] Additional metadata
            #
            #   @param payment_method_id [String] Billing provider payment method id, attached to this customer

            # @see Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora#billing_address
            class BillingAddress < Stigg::Internal::Type::BaseModel
              # @!attribute city
              #   City name
              #
            ...
            # Customers selected currency
            #
            # @see Stigg::Models::V1::CustomerListResponse::Passthrough::Zuora#currency
            module Currency
              extend Stigg::Internal::Type::Enum
