  ...
  module Models
    module V1
      ...
      class Product < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [Stigg::Models::V1::Product::Data]
        required :data, -> { Stigg::V1::Product::Data }

        # @!method initialize(data:)
        #   Response object
        #
        #   @param data [Stigg::Models::V1::Product::Data] Product configuration object

        # @see Stigg::Models::V1::Product#data
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Product::Data::Status]
          ...
          #
          #   @return [Stigg::Models::V1::Product::Data::ProductSettings, nil]
          ...
          #
          #   @param status [Symbol, Stigg::Models::V1::Product::Data::Status] The status of the product
          #
          #   @param updated_at [Time] Timestamp of when the record was last updated
          #
          #   @param product_settings [Stigg::Models::V1::Product::Data::ProductSettings] Product behavior settings for subscription lifecycle management.

          # The status of the product
          #
          # @see Stigg::Models::V1::Product::Data#status
          module Status
          ...
          # @see Stigg::Models::V1::Product::Data#product_settings
          class ProductSettings < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Product::Data::ProductSettings::SubscriptionCancellationTime]
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Product::Data::ProductSettings::SubscriptionEndSetup]
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Product::Data::ProductSettings::SubscriptionStartSetup]
            ...
            #   {Stigg::Models::V1::Product::Data::ProductSettings} for more details.
            #
            #   Product behavior settings for subscription lifecycle management.
            #
            #   @param subscription_cancellation_time [Symbol, Stigg::Models::V1::Product::Data::ProductSettings::SubscriptionCancellationTime] Time when the subscription will be cancelled
            #
            #   @param subscription_end_setup [Symbol, Stigg::Models::V1::Product::Data::ProductSettings::SubscriptionEndSetup] Setup for the end of the subscription
            #
            ...
            # Time when the subscription will be cancelled
            #
            # @see Stigg::Models::V1::Product::Data::ProductSettings#subscription_cancellation_time
            ...
            # Setup for the end of the subscription
            #
            # @see Stigg::Models::V1::Product::Data::ProductSettings#subscription_end_setup
            ...
            # Setup for the start of the subscription
            #
            # @see Stigg::Models::V1::Product::Data::ProductSettings#subscription_start_setup
