...
module Stigg
  module Models
    module V1
      module Credits
        # @see Stigg::Resources::V1::Credits::Grants#list
        class GrantListResponse < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Credits::GrantListResponse::Cost]
          required :cost, -> { Stigg::Models::V1::Credits::GrantListResponse::Cost }
          ...
          required :grant_type,
                   enum: -> { Stigg::Models::V1::Credits::GrantListResponse::GrantType },
                   api_name: :grantType
          ...
          #
          #   @return [Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice, nil]
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Credits::GrantListResponse::PaymentCollection]
          required :payment_collection,
                   enum: -> { Stigg::Models::V1::Credits::GrantListResponse::PaymentCollection },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Credits::GrantListResponse::SourceType, nil]
          required :source_type,
                   enum: -> { Stigg::Models::V1::Credits::GrantListResponse::SourceType },
                   api_name: :sourceType,
                   nil?: true
          ...
          #
          #   @param cost [Stigg::Models::V1::Credits::GrantListResponse::Cost] The monetary cost of the credit grant
          #
          ...
          #
          #   @param latest_invoice [Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice, nil] The latest invoice details for this grant
          #
          #   @param metadata [Hash{Symbol=>String}] Metadata associated with the entity
          #
          #   @param payment_collection [Symbol, Stigg::Models::V1::Credits::GrantListResponse::PaymentCollection] The payment collection status
          #
          ...
          # @see Stigg::Models::V1::Credits::GrantListResponse#cost
          ...
          # @see Stigg::Models::V1::Credits::GrantListResponse#latest_invoice
          class LatestInvoice < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::BillingReason, nil]
            required :billing_reason,
                     enum: -> { Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::BillingReason },
            ...
            #   The invoice status
            #
            #   @return [Symbol, Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::Status]
            required :status, enum: -> { Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::Status }
            ...
            #
            #   @param billing_reason [Symbol, Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::BillingReason, nil] The billing reason for the invoice
            #
            ...
            #
            #   @param status [Symbol, Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice::Status] The invoice status
            #
            ...
            # The billing reason for the invoice
            #
            # @see Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice#billing_reason
            ...
            # The invoice status
            #
            # @see Stigg::Models::V1::Credits::GrantListResponse::LatestInvoice#status
            module Status
              extend Stigg::Internal::Type::Enum
          ...
          # The payment collection status
          #
          # @see Stigg::Models::V1::Credits::GrantListResponse#payment_collection
          ...
          # The source type of the grant (PRICE, PLAN_ENTITLEMENT, ADDON_ENTITLEMENT)
          #
          # @see Stigg::Models::V1::Credits::GrantListResponse#source_type
          module SourceType
            extend Stigg::Internal::Type::Enum
