    ...
    module V1
      module Credits
        ...
        class CustomCurrencyListResponse < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Credits::CustomCurrencyListResponse::Units, nil]
          ...
          #
          #   @param units [Stigg::Models::V1::Credits::CustomCurrencyListResponse::Units, nil] Singular and plural unit labels for a custom currency
          #
          #   @param updated_at [Time] Timestamp of when the record was last updated

          # @see Stigg::Models::V1::Credits::CustomCurrencyListResponse#units
