...
module Stigg
  module Models
    module V1
      module Credits
        # @see Stigg::Resources::V1::Credits::CustomCurrencies#list_associated_entities
        class CustomCurrencyListAssociatedEntitiesResponse < Stigg::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Array<Stigg::Models::V1::Credits::CustomCurrencyListAssociatedEntitiesResponse::Data>]
          required :data,
                   -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::Credits::CustomCurrencyListAssociatedEntitiesResponse::Data] }

          # @!method initialize(data:)
          #   List of entities (plans or addons) that reference a custom currency
          #
          #   @param data [Array<Stigg::Models::V1::Credits::CustomCurrencyListAssociatedEntitiesResponse::Data>]
