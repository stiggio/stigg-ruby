    ...
    module V1
      module Credits
        ...
        class CreditGrantResponse < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Credits::CreditGrantResponse::Data]
          required :data, -> { Stigg::V1::Credits::CreditGrantResponse::Data }

          # @!method initialize(data:)
          #   Response object
          #
          #   @param data [Stigg::Models::V1::Credits::CreditGrantResponse::Data] Credit grant object representing allocated credits for a customer

          # @see Stigg::Models::V1::Credits::CreditGrantResponse#data
          class Data < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Stigg::Models::V1::Credits::CreditGrantResponse::Data::Cost]
            ...
            #
            #   @return [Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice, nil]
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::PaymentCollection]
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::SourceType, nil]
            ...
            #
            #   @param cost [Stigg::Models::V1::Credits::CreditGrantResponse::Data::Cost] The monetary cost of the credit grant
            #
            ...
            #
            #   @param latest_invoice [Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice, nil] The latest invoice details for this grant
            #
            #   @param metadata [Hash{Symbol=>String}] Metadata associated with the entity
            #
            #   @param payment_collection [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::PaymentCollection] The payment collection status
            #
            ...
            # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data#cost
            ...
            # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data#latest_invoice
            class LatestInvoice < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice::BillingReason, nil]
              ...
              #   The invoice status
              #
              #   @return [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice::Status]
              ...
              #
              #   @param billing_reason [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice::BillingReason, nil] The billing reason for the invoice
              #
              ...
              #
              #   @param status [Symbol, Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice::Status] The invoice status
              #
              ...
              # The billing reason for the invoice
              #
              # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice#billing_reason
              ...
              # The invoice status
              #
              # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data::LatestInvoice#status
              module Status
                extend Stigg::Internal::Type::Enum
            ...
            # The payment collection status
            #
            # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data#payment_collection
            ...
            # The source type of the grant (PRICE, PLAN_ENTITLEMENT, ADDON_ENTITLEMENT)
            #
            # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data#source_type
            module SourceType
              extend Stigg::Internal::Type::Enum
            ...
            # The effective status of the credit grant
            #
            # @see Stigg::Models::V1::Credits::CreditGrantResponse::Data#status
            module Status
              extend Stigg::Internal::Type::Enum
