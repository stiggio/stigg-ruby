...
module Stigg
  module Models
    module V1
      # @see Stigg::Resources::V1::Plans#list
      class PlanListResponse < Stigg::Internal::Type::BaseModel
        # @!attribute id
        ...
        required :default_trial_config,
                 -> { Stigg::Models::V1::PlanListResponse::DefaultTrialConfig },
        ...
        #
        #   @return [Array<Stigg::Models::V1::PlanListResponse::Entitlement>]
        required :entitlements,
                 -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::PlanListResponse::Entitlement] }
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListResponse::PricingType, nil]
        required :pricing_type,
                 enum: -> { Stigg::Models::V1::PlanListResponse::PricingType },
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListResponse::Status]
        required :status, enum: -> { Stigg::Models::V1::PlanListResponse::Status }
        ...
        #
        #   @param entitlements [Array<Stigg::Models::V1::PlanListResponse::Entitlement>] List of entitlements of the package
        #
        ...
        #
        #   @param status [Symbol, Stigg::Models::V1::PlanListResponse::Status] The status of the package
        #
        #   @param updated_at [Time] Timestamp of when the record was last updated
        #
        #   @param version_number [Integer] The version number of the package

        # @see Stigg::Models::V1::PlanListResponse#default_trial_config
        class DefaultTrialConfig < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::Units]
          required :units, enum: -> { Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::Units }

          # @!attribute budget
          #   Budget configuration for the trial
          #
          #   @return [Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::Budget, nil]
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::TrialEndBehavior, nil]
          ...
          #
          #   @param units [Symbol, Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::Units] The time unit for the trial duration (DAY or MONTH)
          #
          #   @param budget [Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::Budget, nil] Budget configuration for the trial
          #
          #   @param trial_end_behavior [Symbol, Stigg::Models::V1::PlanListResponse::DefaultTrialConfig::TrialEndBehavior, nil] Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)

          # The time unit for the trial duration (DAY or MONTH)
          #
          # @see Stigg::Models::V1::PlanListResponse::DefaultTrialConfig#units
          module Units
          ...
          # @see Stigg::Models::V1::PlanListResponse::DefaultTrialConfig#budget
          ...
          # Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)
          #
          # @see Stigg::Models::V1::PlanListResponse::DefaultTrialConfig#trial_end_behavior
        ...
        class Entitlement < Stigg::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, Stigg::Models::V1::PlanListResponse::Entitlement::Type]
          required :type, enum: -> { Stigg::Models::V1::PlanListResponse::Entitlement::Type }
          ...
          #   @param id [String] The unique identifier for the entity
          #
          #   @param type [Symbol, Stigg::Models::V1::PlanListResponse::Entitlement::Type]

          # @see Stigg::Models::V1::PlanListResponse::Entitlement#type
          module Type
            extend Stigg::Internal::Type::Enum
        ...
        # The pricing type of the package
        #
        # @see Stigg::Models::V1::PlanListResponse#pricing_type
        module PricingType
          extend Stigg::Internal::Type::Enum
        ...
        # The status of the package
        #
        # @see Stigg::Models::V1::PlanListResponse#status
        module Status
          extend Stigg::Internal::Type::Enum
