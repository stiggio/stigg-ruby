...
module Stigg
  module Models
    module V1
      module Events
        # @see Stigg::Resources::V1::Events::Addons#archive_addon
        class AddonArchiveAddonResponse < Stigg::Internal::Type::BaseModel
          # @!attribute data
          #   Addon configuration object
          #
          #   @return [Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data]
          required :data, -> { Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data }

          # @!method initialize(data:)
          #   Response object
          #
          #   @param data [Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data] Addon configuration object

          # @see Stigg::Models::V1::Events::AddonArchiveAddonResponse#data
          class Data < Stigg::Internal::Type::BaseModel
            ...
            required :entitlements,
                     -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Entitlement] }
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::PricingType, nil]
            required :pricing_type,
                     enum: -> { Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::PricingType },
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Status]
            required :status, enum: -> { Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Status }
            ...
            class Entitlement < Stigg::Internal::Type::BaseModel
              ...
              # @!attribute type
              #
              #   @return [Symbol, Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Entitlement::Type]
              required :type, enum: -> { Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Entitlement::Type }
              ...
              #   @param id [String] The unique identifier for the entity
              #
              #   @param type [Symbol, Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Entitlement::Type]

              # @see Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data::Entitlement#type
              module Type
            ...
            # The pricing type of the package
            #
            # @see Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data#pricing_type
            module PricingType
              extend Stigg::Internal::Type::Enum
            ...
            # The status of the package
            #
            # @see Stigg::Models::V1::Events::AddonArchiveAddonResponse::Data#status
            module Status
              extend Stigg::Internal::Type::Enum
