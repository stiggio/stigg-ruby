...
module Stigg
  module Models
    module V1
      module Events
        # @see Stigg::Resources::V1::Events::Addons#retrieve_addon
        class AddonRetrieveAddonResponse < Stigg::Internal::Type::BaseModel
          # @!attribute data
          #   Addon configuration object
          #
          #   @return [Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data]
          required :data, -> { Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data }

          # @!method initialize(data:)
          #   Response object
          #
          #   @param data [Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data] Addon configuration object

          # @see Stigg::Models::V1::Events::AddonRetrieveAddonResponse#data
          class Data < Stigg::Internal::Type::BaseModel
            ...
            required :entitlements,
                     -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Entitlement] }
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::PricingType, nil]
            required :pricing_type,
                     enum: -> { Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::PricingType },
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Status]
            required :status, enum: -> { Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Status }
            ...
            class Entitlement < Stigg::Internal::Type::BaseModel
              ...
              # @!attribute type
              #
              #   @return [Symbol, Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Entitlement::Type]
              required :type,
                       enum: -> { Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Entitlement::Type }
              ...
              #   @param id [String] The unique identifier for the entity
              #
              #   @param type [Symbol, Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Entitlement::Type]

              # @see Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data::Entitlement#type
              module Type
            ...
            # The pricing type of the package
            #
            # @see Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data#pricing_type
            module PricingType
              extend Stigg::Internal::Type::Enum
            ...
            # The status of the package
            #
            # @see Stigg::Models::V1::Events::AddonRetrieveAddonResponse::Data#status
            module Status
              extend Stigg::Internal::Type::Enum
