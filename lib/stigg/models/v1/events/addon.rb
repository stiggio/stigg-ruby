    ...
    module V1
      module Events
        ...
        class Addon < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Events::Addon::Data]
          required :data, -> { Stigg::V1::Events::Addon::Data }

          # @!method initialize(data:)
          #   Response object
          #
          #   @param data [Stigg::Models::V1::Events::Addon::Data] Addon configuration object

          # @see Stigg::Models::V1::Events::Addon#data
          class Data < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Stigg::Models::V1::Events::Addon::Data::Entitlement>]
            required :entitlements, -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::Events::Addon::Data::Entitlement] }
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::Addon::Data::PricingType, nil]
            required :pricing_type,
                     enum: -> { Stigg::V1::Events::Addon::Data::PricingType },
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::Addon::Data::Status]
            required :status, enum: -> { Stigg::V1::Events::Addon::Data::Status }
            ...
            #
            #   @param entitlements [Array<Stigg::Models::V1::Events::Addon::Data::Entitlement>] List of entitlements of the package
            #
            ...
            #
            #   @param pricing_type [Symbol, Stigg::Models::V1::Events::Addon::Data::PricingType, nil] The pricing type of the package
            #
            #   @param product_id [String] The product id of the package
            #
            #   @param status [Symbol, Stigg::Models::V1::Events::Addon::Data::Status] The status of the package
            #
            ...
            class Entitlement < Stigg::Internal::Type::BaseModel
              ...
              # @!attribute type
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Addon::Data::Entitlement::Type]
              required :type, enum: -> { Stigg::V1::Events::Addon::Data::Entitlement::Type }
              ...
              #   @param id [String] The unique identifier for the entity
              #
              #   @param type [Symbol, Stigg::Models::V1::Events::Addon::Data::Entitlement::Type]

              # @see Stigg::Models::V1::Events::Addon::Data::Entitlement#type
              module Type
            ...
            # The pricing type of the package
            #
            # @see Stigg::Models::V1::Events::Addon::Data#pricing_type
            module PricingType
              extend Stigg::Internal::Type::Enum
            ...
            # The status of the package
            #
            # @see Stigg::Models::V1::Events::Addon::Data#status
            module Status
              extend Stigg::Internal::Type::Enum
