    ...
    module V1
      module Events
        module Addons
          ...
          class DraftCreateAddonDraftResponse < Stigg::Internal::Type::BaseModel
            # @!attribute data
            #   Addon configuration object
            #
            #   @return [Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data]
            required :data, -> { Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data }

            # @!method initialize(data:)
            #   Response object
            #
            #   @param data [Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data] Addon configuration object

            # @see Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse#data
            class Data < Stigg::Internal::Type::BaseModel
              ...
              required :entitlements,
                       -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Entitlement] }
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::PricingType, nil]
              required :pricing_type,
                       enum: -> { Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::PricingType },
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Status]
              required :status,
                       enum: -> { Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Status }
              ...
              class Entitlement < Stigg::Internal::Type::BaseModel
                ...
                # @!attribute type
                #
                #   @return [Symbol, Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Entitlement::Type]
                required :type,
                         enum: -> { Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Entitlement::Type }
                ...
                #   @param id [String] The unique identifier for the entity
                #
                #   @param type [Symbol, Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Entitlement::Type]

                # @see Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data::Entitlement#type
                module Type
              ...
              # The pricing type of the package
              #
              # @see Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data#pricing_type
              module PricingType
                extend Stigg::Internal::Type::Enum
              ...
              # The status of the package
              #
              # @see Stigg::Models::V1::Events::Addons::DraftCreateAddonDraftResponse::Data#status
              module Status
                extend Stigg::Internal::Type::Enum
