  ...
  module Models
    module V1
      module Events
        module Beta
          module Customers
            # @see Stigg::Resources::V1::Events::Beta::Customers::Entities#list
            class EntityListParams < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Beta::Customers::EntityListParams::IncludeArchived, nil]
              optional :include_archived,
                       enum: -> { Stigg::V1::Events::Beta::Customers::EntityListParams::IncludeArchived }
