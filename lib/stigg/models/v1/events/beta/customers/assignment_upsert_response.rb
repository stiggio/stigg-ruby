        ...
        module Beta
          module Customers
            ...
            class AssignmentUpsertResponse < Stigg::Internal::Type::BaseModel
              # @!attribute data
              #
              #   @return [Array<Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data>]
              required :data,
                       -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data] }

              # @!method initialize(data:)
              #   Assignments after upsert.
              #
              #   @param data [Array<Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data>]
              ...
              class Data < Stigg::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::Cadence]
                required :cadence,
                         enum: -> { Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::Cadence }
                ...
                #
                #   @param cadence [Symbol, Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data::Cadence] Usage-reset cadence. Currently only `MONTH` is supported
                #
                ...
                # Usage-reset cadence. Currently only `MONTH` is supported
                #
                # @see Stigg::Models::V1::Events::Beta::Customers::AssignmentUpsertResponse::Data#cadence
                module Cadence
