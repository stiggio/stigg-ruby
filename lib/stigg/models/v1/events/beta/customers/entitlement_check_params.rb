        ...
        module Beta
          module Customers
            ...
            class EntitlementCheckParams < Stigg::Internal::Type::BaseModel
              ...
              # @!method initialize(id:, currency_id: nil, dimensions: nil, feature_id: nil, requested_usage: nil, requested_values: nil, resource_id: nil, x_account_id: nil, x_environment_id: nil, request_options: {})
