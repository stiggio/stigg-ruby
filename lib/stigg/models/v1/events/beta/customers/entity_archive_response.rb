        ...
        module Beta
          module Customers
            ...
            class EntityArchiveResponse < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Stigg::Models::V1::Events::Beta::Customers::EntityArchiveResponse::Data]
              required :data, -> { Stigg::Models::V1::Events::Beta::Customers::EntityArchiveResponse::Data }

              # @!method initialize(data:)
              #   Wrapped response echoing the ids that were acted on by an archive/unarchive call
              #
              #   @param data [Stigg::Models::V1::Events::Beta::Customers::EntityArchiveResponse::Data] List of entity identifiers that were acted on

              # @see Stigg::Models::V1::Events::Beta::Customers::EntityArchiveResponse#data
