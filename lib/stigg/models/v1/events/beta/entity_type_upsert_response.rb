...
module Stigg
  module Models
    module V1
      module Events
        module Beta
          # @see Stigg::Resources::V1::Events::Beta::EntityTypes#upsert
          class EntityTypeUpsertResponse < Stigg::Internal::Type::BaseModel
            # @!attribute data
            #
            #   @return [Array<Stigg::Models::V1::Events::Beta::EntityTypeUpsertResponse::Data>]
            required :data,
                     -> { Stigg::Internal::Type::ArrayOf[Stigg::Models::V1::Events::Beta::EntityTypeUpsertResponse::Data] }

            # @!method initialize(data:)
            #   Entity types after upsert.
            #
            #   @param data [Array<Stigg::Models::V1::Events::Beta::EntityTypeUpsertResponse::Data>]
            ...
            class Data < Stigg::Internal::Type::BaseModel
              ...
              #   {Stigg::Models::V1::Events::Beta::EntityTypeUpsertResponse::Data} for more
              #   details.
              #
