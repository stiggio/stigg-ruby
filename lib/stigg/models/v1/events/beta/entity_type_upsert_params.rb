      ...
      module Events
        module Beta
          ...
          class EntityTypeUpsertParams < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Stigg::Models::V1::Events::Beta::EntityTypeUpsertParams::Type>]
            required :types,
                     -> { Stigg::Internal::Type::ArrayOf[Stigg::V1::Events::Beta::EntityTypeUpsertParams::Type] }
            ...
            # @!method initialize(types:, x_account_id: nil, x_environment_id: nil, request_options: {})
            ...
            class Type < Stigg::Internal::Type::BaseModel
              ...
              #   {Stigg::Models::V1::Events::Beta::EntityTypeUpsertParams::Type} for more
              #   details.
              #
