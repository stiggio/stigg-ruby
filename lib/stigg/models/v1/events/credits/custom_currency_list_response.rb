    ...
    module V1
      module Events
        module Credits
          ...
          class CustomCurrencyListResponse < Stigg::Internal::Type::BaseModel
            # @!attribute id
            ...
            #
            #   @return [Stigg::Models::V1::Events::Credits::CustomCurrencyListResponse::Units, nil]
            required :units, -> { Stigg::Models::V1::Events::Credits::CustomCurrencyListResponse::Units }, nil?: true
            ...
            #
            #   @param units [Stigg::Models::V1::Events::Credits::CustomCurrencyListResponse::Units, nil] Singular and plural unit labels for a custom currency
            #
            #   @param updated_at [Time] Timestamp of when the record was last updated

            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyListResponse#units
