...
module Stigg
  module Models
    module V1
      module Events
        module Credits
          # @see Stigg::Resources::V1::Events::Credits::CustomCurrencies#unarchive
          class CustomCurrencyUnarchiveResponse < Stigg::Internal::Type::BaseModel
            # @!attribute data
            #   A custom currency used to denominate credit-based entitlements and pricing
            #
            #   @return [Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data]
            required :data, -> { Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data }

            # @!method initialize(data:)
            #   Response object
            #
            #   @param data [Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data] A custom currency used to denominate credit-based entitlements and pricing

            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse#data
            class Data < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data::Units, nil]
              required :units,
                       -> { Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data::Units },
                       nil?: true
              ...
              #
              #   @param units [Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data::Units, nil] Singular and plural unit labels for a custom currency
              #
              #   @param updated_at [Time] Timestamp of when the record was last updated

              # @see Stigg::Models::V1::Events::Credits::CustomCurrencyUnarchiveResponse::Data#units
