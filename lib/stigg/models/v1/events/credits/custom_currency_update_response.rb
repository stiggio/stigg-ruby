    ...
    module V1
      module Events
        module Credits
          ...
          class CustomCurrencyUpdateResponse < Stigg::Internal::Type::BaseModel
            # @!attribute data
            #   A custom currency used to denominate credit-based entitlements and pricing
            #
            #   @return [Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse::Data]
            required :data, -> { Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse::Data }

            # @!method initialize(data:)
            #   Response object
            #
            #   @param data [Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse::Data] A custom currency used to denominate credit-based entitlements and pricing

            # @see Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse#data
            class Data < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse::Data::Units, nil]
              required :units,
              ...
              #
              #   @param units [Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse::Data::Units, nil] Singular and plural unit labels for a custom currency
              #
              #   @param updated_at [Time] Timestamp of when the record was last updated

              # @see Stigg::Models::V1::Events::Credits::CustomCurrencyUpdateResponse::Data#units
