      ...
      module Events
        module Credits
          ...
          class CreditGrantResponse < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data]
            required :data, -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data }

            # @!method initialize(data:)
            #   Response object
            #
            #   @param data [Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data] Credit grant object representing allocated credits for a customer

            # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse#data
            class Data < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::Cost]
              required :cost, -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data::Cost }
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::GrantType]
              required :grant_type,
                       enum: -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data::GrantType },
                       api_name: :grantType
              ...
              #
              #   @return [Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice, nil]
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::PaymentCollection]
              required :payment_collection,
                       enum: -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data::PaymentCollection },
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::SourceType, nil]
              required :source_type,
                       enum: -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data::SourceType },
                       api_name: :sourceType,
                       nil?: true
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::Status]
              required :status, enum: -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data::Status }
              ...
              #
              #   @param cost [Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::Cost] The monetary cost of the credit grant
              #
              ...
              #
              #   @param grant_type [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::GrantType] The type of credit grant (PAID, PROMOTIONAL, RECURRING)
              #
              #   @param invoice_id [String, nil] The billing invoice ID associated with this grant
              #
              #   @param latest_invoice [Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice, nil] The latest invoice details for this grant
              #
              #   @param metadata [Hash{Symbol=>String}] Metadata associated with the entity
              #
              #   @param payment_collection [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::PaymentCollection] The payment collection status
              #
              ...
              #
              #   @param source_type [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::SourceType, nil] The source type of the grant (PRICE, PLAN_ENTITLEMENT, ADDON_ENTITLEMENT)
              #
              #   @param status [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::Status] The effective status of the credit grant
              #
              #   @param updated_at [Time] Timestamp of when the record was last updated
              #
              #   @param voided_at [Time, nil] The date when the credit grant was voided

              # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data#cost
              ...
              # The type of credit grant (PAID, PROMOTIONAL, RECURRING)
              #
              # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data#grant_type
              module GrantType
              ...
              # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data#latest_invoice
              class LatestInvoice < Stigg::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice::BillingReason, nil]
                ...
                #   The invoice status
                #
                #   @return [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice::Status]
                required :status,
                         enum: -> { Stigg::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice::Status }
                ...
                #
                #   @param billing_reason [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice::BillingReason, nil] The billing reason for the invoice
                #
                ...
                #
                #   @param status [Symbol, Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice::Status] The invoice status
                #
                ...
                # The billing reason for the invoice
                #
                # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice#billing_reason
                ...
                # The invoice status
                #
                # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data::LatestInvoice#status
                module Status
                  extend Stigg::Internal::Type::Enum
              ...
              # The payment collection status
              #
              # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data#payment_collection
              ...
              # The source type of the grant (PRICE, PLAN_ENTITLEMENT, ADDON_ENTITLEMENT)
              #
              # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data#source_type
              module SourceType
                extend Stigg::Internal::Type::Enum
              ...
              # The effective status of the credit grant
              #
              # @see Stigg::Models::V1::Events::Credits::CreditGrantResponse::Data#status
              module Status
                extend Stigg::Internal::Type::Enum
