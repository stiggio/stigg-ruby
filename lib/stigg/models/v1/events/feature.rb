    ...
    module V1
      module Events
        ...
        class Feature < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Events::Feature::Data]
          required :data, -> { Stigg::V1::Events::Feature::Data }

          # @!method initialize(data:)
          #   Response object
          #
          #   @param data [Stigg::Models::V1::Events::Feature::Data] Feature configuration object

          # @see Stigg::Models::V1::Events::Feature#data
          class Data < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Stigg::Models::V1::Events::Feature::Data::EnumConfiguration>, nil]
            required :enum_configuration,
                     -> {
                       Stigg::Internal::Type::ArrayOf[Stigg::V1::Events::Feature::Data::EnumConfiguration]
                     },
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::Feature::Data::FeatureStatus]
            required :feature_status,
                     enum: -> { Stigg::V1::Events::Feature::Data::FeatureStatus },
                     api_name: :featureStatus

            # @!attribute feature_type
            #   The type of the feature
            #
            #   @return [Symbol, Stigg::Models::V1::Events::Feature::Data::FeatureType]
            required :feature_type,
                     enum: -> {
                       Stigg::V1::Events::Feature::Data::FeatureType
                     },
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Events::Feature::Data::MeterType]
            required :meter_type,
                     enum: -> {
                       Stigg::V1::Events::Feature::Data::MeterType
                     },
                     api_name: :meterType
            ...
            #
            #   @return [Stigg::Models::V1::Events::Feature::Data::UnitTransformation, nil]
            required :unit_transformation,
                     -> { Stigg::V1::Events::Feature::Data::UnitTransformation },
            ...
            #
            #   @param enum_configuration [Array<Stigg::Models::V1::Events::Feature::Data::EnumConfiguration>, nil] The configuration data for the feature
            #
            #   @param feature_status [Symbol, Stigg::Models::V1::Events::Feature::Data::FeatureStatus] The status of the feature
            #
            #   @param feature_type [Symbol, Stigg::Models::V1::Events::Feature::Data::FeatureType] The type of the feature
            #
            ...
            #
            #   @param meter_type [Symbol, Stigg::Models::V1::Events::Feature::Data::MeterType] The meter type for the feature
            #
            #   @param unit_transformation [Stigg::Models::V1::Events::Feature::Data::UnitTransformation, nil] Unit transformation to be applied to the reported usage
            #
            ...
            # The status of the feature
            #
            # @see Stigg::Models::V1::Events::Feature::Data#feature_status
            ...
            # The type of the feature
            #
            # @see Stigg::Models::V1::Events::Feature::Data#feature_type
            module FeatureType
              extend Stigg::Internal::Type::Enum
            ...
            # The meter type for the feature
            #
            # @see Stigg::Models::V1::Events::Feature::Data#meter_type
            module MeterType
              extend Stigg::Internal::Type::Enum
            ...
            # @see Stigg::Models::V1::Events::Feature::Data#unit_transformation
            class UnitTransformation < Stigg::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Stigg::Models::V1::Events::Feature::Data::UnitTransformation::Round]
              required :round, enum: -> { Stigg::V1::Events::Feature::Data::UnitTransformation::Round }
              ...
              #
              #   @param round [Symbol, Stigg::Models::V1::Events::Feature::Data::UnitTransformation::Round] After division, either round the result up or down

              # After division, either round the result up or down
              #
              # @see Stigg::Models::V1::Events::Feature::Data::UnitTransformation#round
              module Round
                extend Stigg::Internal::Type::Enum
