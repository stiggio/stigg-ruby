    ...
    module V1
      module Events
        ...
        class AddonListAddonsResponse < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Events::AddonListAddonsResponse::PricingType, nil]
          required :pricing_type,
                   enum: -> { Stigg::Models::V1::Events::AddonListAddonsResponse::PricingType },
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Events::AddonListAddonsResponse::Status]
          required :status, enum: -> { Stigg::Models::V1::Events::AddonListAddonsResponse::Status }
          ...
          class Entitlement < Stigg::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, Stigg::Models::V1::Events::AddonListAddonsResponse::Entitlement::Type]
            required :type, enum: -> { Stigg::Models::V1::Events::AddonListAddonsResponse::Entitlement::Type }
            ...
            #   @param id [String] The unique identifier for the entity
            #
            #   @param type [Symbol, Stigg::Models::V1::Events::AddonListAddonsResponse::Entitlement::Type]

            # @see Stigg::Models::V1::Events::AddonListAddonsResponse::Entitlement#type
            module Type
          ...
          # The pricing type of the package
          #
          # @see Stigg::Models::V1::Events::AddonListAddonsResponse#pricing_type
          module PricingType
            extend Stigg::Internal::Type::Enum
          ...
          # The status of the package
          #
          # @see Stigg::Models::V1::Events::AddonListAddonsResponse#status
          module Status
            extend Stigg::Internal::Type::Enum
