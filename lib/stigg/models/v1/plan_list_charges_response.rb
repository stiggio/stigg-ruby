...
module Stigg
  module Models
    module V1
      # @see Stigg::Resources::V1::Plans#list_charges
      class PlanListChargesResponse < Stigg::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::BillingCadence]
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::BillingModel]
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::BillingPeriod]
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::CreditGrantCadence, nil]
        ...
        #
        #   @return [Stigg::Models::V1::PlanListChargesResponse::CreditRate, nil]
        ...
        #
        #   @return [Stigg::Models::V1::PlanListChargesResponse::Price, nil]
        optional :price, -> { Stigg::Models::V1::PlanListChargesResponse::Price }, nil?: true

        # @!attribute tiers
        #   Tiered pricing rows when the charge is tiered
        #
        #   @return [Array<Stigg::Models::V1::PlanListChargesResponse::Tier>, nil]
        optional :tiers,
        ...
        #
        #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::TiersMode, nil]
        optional :tiers_mode,
        ...
        #   {Stigg::Models::V1::PlanListChargesResponse} for more details.
        #
        ...
        #
        #   @param billing_cadence [Symbol, Stigg::Models::V1::PlanListChargesResponse::BillingCadence] The billing cadence (RECURRING or ONE_OFF)
        #
        #   @param billing_model [Symbol, Stigg::Models::V1::PlanListChargesResponse::BillingModel] The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
        #
        #   @param billing_period [Symbol, Stigg::Models::V1::PlanListChargesResponse::BillingPeriod] The billing period (MONTHLY or ANNUALLY)
        #
        ...
        #
        #   @param credit_grant_cadence [Symbol, Stigg::Models::V1::PlanListChargesResponse::CreditGrantCadence, nil] When credits are granted (for credit-based pricing)
        #
        #   @param credit_rate [Stigg::Models::V1::PlanListChargesResponse::CreditRate, nil] Credit rate configuration for credit-based pricing
        #
        ...
        #
        #   @param price [Stigg::Models::V1::PlanListChargesResponse::Price, nil] The flat price amount and currency, when applicable
        #
        #   @param tiers [Array<Stigg::Models::V1::PlanListChargesResponse::Tier>, nil] Tiered pricing rows when the charge is tiered
        #
        #   @param tiers_mode [Symbol, Stigg::Models::V1::PlanListChargesResponse::TiersMode, nil] Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
        #
        ...
        # The billing cadence (RECURRING or ONE_OFF)
        #
        # @see Stigg::Models::V1::PlanListChargesResponse#billing_cadence
        ...
        # The billing model (FLAT_FEE, PER_UNIT, USAGE_BASED, CREDIT_BASED, MINIMUM_SPEND)
        #
        # @see Stigg::Models::V1::PlanListChargesResponse#billing_model
        module BillingModel
          extend Stigg::Internal::Type::Enum
        ...
        # The billing period (MONTHLY or ANNUALLY)
        #
        # @see Stigg::Models::V1::PlanListChargesResponse#billing_period
        ...
        # When credits are granted (for credit-based pricing)
        #
        # @see Stigg::Models::V1::PlanListChargesResponse#credit_grant_cadence
        ...
        # @see Stigg::Models::V1::PlanListChargesResponse#credit_rate
        ...
        # @see Stigg::Models::V1::PlanListChargesResponse#price
        class Price < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::Price::Currency]
          required :currency, enum: -> { Stigg::Models::V1::PlanListChargesResponse::Price::Currency }
          ...
          #
          #   @param currency [Symbol, Stigg::Models::V1::PlanListChargesResponse::Price::Currency] ISO 4217 currency code

          # ISO 4217 currency code
          #
          # @see Stigg::Models::V1::PlanListChargesResponse::Price#currency
          module Currency
            extend Stigg::Internal::Type::Enum
        ...
        class Tier < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice, nil]
          optional :flat_price,
                   -> { Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice },
                   api_name: :flatPrice,
                   nil?: true
          ...
          #
          #   @return [Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice, nil]
          optional :unit_price,
                   -> { Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice },
                   api_name: :unitPrice,
                   nil?: true
          ...
          #
          #   @param flat_price [Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice, nil] Flat price for this tier
          #
          #   @param unit_price [Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice, nil] Per-unit price in this tier
          #
          #   @param up_to [Float, nil] Upper bound of this tier (null for unlimited)

          # @see Stigg::Models::V1::PlanListChargesResponse::Tier#flat_price
          class FlatPrice < Stigg::Internal::Type::BaseModel
            ...
            #   ISO 4217 currency code
            #
            #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice::Currency]
            required :currency, enum: -> { Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice::Currency }
            ...
            #   @param amount [Float] The price amount
            #
            #   @param currency [Symbol, Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice::Currency] ISO 4217 currency code

            # ISO 4217 currency code
            #
            # @see Stigg::Models::V1::PlanListChargesResponse::Tier::FlatPrice#currency
            module Currency
              extend Stigg::Internal::Type::Enum
          ...
          # @see Stigg::Models::V1::PlanListChargesResponse::Tier#unit_price
          class UnitPrice < Stigg::Internal::Type::BaseModel
            ...
            #   ISO 4217 currency code
            #
            #   @return [Symbol, Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice::Currency]
            required :currency, enum: -> { Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice::Currency }
            ...
            #   @param amount [Float] The price amount
            #
            #   @param currency [Symbol, Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice::Currency] ISO 4217 currency code

            # ISO 4217 currency code
            #
            # @see Stigg::Models::V1::PlanListChargesResponse::Tier::UnitPrice#currency
            module Currency
              extend Stigg::Internal::Type::Enum
        ...
        # Tiered pricing mode (VOLUME or GRADUATED) when the charge is tiered
        #
        # @see Stigg::Models::V1::PlanListChargesResponse#tiers_mode
        module TiersMode
          extend Stigg::Internal::Type::Enum
