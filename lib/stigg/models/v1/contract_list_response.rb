...
module Stigg
  module Models
    module V1
      ...
      class ContractListResponse < Stigg::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Stigg::Models::V1::ContractListResponse::LatestInvoice, nil]
        ...
        #
        #   @return [Stigg::Models::V1::ContractListResponse::NextInvoice, nil]
        required :next_invoice,
                 -> { Stigg::Models::V1::ContractListResponse::NextInvoice },
        ...
        #   The current state of the contract
        #
        #   @return [Symbol, Stigg::Models::V1::ContractListResponse::State]
        required :state, enum: -> { Stigg::Models::V1::ContractListResponse::State }

        # @!attribute subscriptions
        #   The custom subscriptions attached to this contract (empty when none)
        #
        #   @return [Array<Stigg::Models::V1::ContractListResponse::Subscription>]
        ...
        #
        #   @param latest_invoice [Stigg::Models::V1::ContractListResponse::LatestInvoice, nil] The most recent non-draft invoice for this contract (open, paid, or canceled), o
        #
        #   @param name [String, nil] The contract name (the purchase-order number when set, otherwise the contract/cu
        #
        #   @param next_invoice [Stigg::Models::V1::ContractListResponse::NextInvoice, nil] A preview of the contract's upcoming invoice, or null when none is available
        #
        ...
        #
        #   @param state [Symbol, Stigg::Models::V1::ContractListResponse::State] The current state of the contract
        #
        ...
        class LatestInvoice < Stigg::Internal::Type::BaseModel
          ...
          #   Invoice status
          #
          #   @return [Symbol, Stigg::Models::V1::ContractListResponse::LatestInvoice::Status]
          required :status, enum: -> { Stigg::Models::V1::ContractListResponse::LatestInvoice::Status }
          ...
          #   Billing reason
          #
          #   @return [Symbol, Stigg::Models::V1::ContractListResponse::LatestInvoice::BillingReason, nil]
          optional :billing_reason,
                   enum: -> { Stigg::Models::V1::ContractListResponse::LatestInvoice::BillingReason },
          ...
          #
          #   @param status [Symbol, Stigg::Models::V1::ContractListResponse::LatestInvoice::Status] Invoice status
          #
          #   @param amount_due [Float, nil] Amount due
          #
          #   @param billing_reason [Symbol, Stigg::Models::V1::ContractListResponse::LatestInvoice::BillingReason, nil] Billing reason
          #
          ...
          # Invoice status
          #
          # @see Stigg::Models::V1::ContractListResponse::LatestInvoice#status
          module Status
            extend Stigg::Internal::Type::Enum
          ...
          # Billing reason
          #
          # @see Stigg::Models::V1::ContractListResponse::LatestInvoice#billing_reason
        ...
        # @see Stigg::Models::V1::ContractListResponse#next_invoice
        class NextInvoice < Stigg::Internal::Type::BaseModel
          # @!attribute amount
          #   The total amount of the upcoming invoice
          #
          #   @return [Stigg::Models::V1::ContractListResponse::NextInvoice::Amount]
          ...
          #   A preview of the contract's upcoming invoice, or null when none is available
          #
          #   @param amount [Stigg::Models::V1::ContractListResponse::NextInvoice::Amount] The total amount of the upcoming invoice
          #
          ...
          # @see Stigg::Models::V1::ContractListResponse::NextInvoice#amount
          class Amount < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::ContractListResponse::NextInvoice::Amount::Currency]
            required :currency, enum: -> { Stigg::Models::V1::ContractListResponse::NextInvoice::Amount::Currency }
            ...
            #
            #   @param currency [Symbol, Stigg::Models::V1::ContractListResponse::NextInvoice::Amount::Currency] ISO 4217 currency code

            # ISO 4217 currency code
            #
            # @see Stigg::Models::V1::ContractListResponse::NextInvoice::Amount#currency
            module Currency
              extend Stigg::Internal::Type::Enum
        ...
        # The current state of the contract
        #
        # @see Stigg::Models::V1::ContractListResponse#state
        module State
          extend Stigg::Internal::Type::Enum
