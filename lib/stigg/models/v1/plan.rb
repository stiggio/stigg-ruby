  ...
  module Models
    module V1
      ...
      class Plan < Stigg::Internal::Type::BaseModel
        ...
        #
        #   @return [Stigg::Models::V1::Plan::Data]
        required :data, -> { Stigg::V1::Plan::Data }

        # @!method initialize(data:)
        #   Response object
        #
        #   @param data [Stigg::Models::V1::Plan::Data] Plan configuration object

        # @see Stigg::Models::V1::Plan#data
        class Data < Stigg::Internal::Type::BaseModel
          ...
          #
          #   @return [Stigg::Models::V1::Plan::Data::DefaultTrialConfig, nil]
          ...
          #
          #   @return [Array<Stigg::Models::V1::Plan::Data::Entitlement>]
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Plan::Data::PricingType, nil]
          ...
          #
          #   @return [Symbol, Stigg::Models::V1::Plan::Data::Status]
          ...
          #
          #   @param default_trial_config [Stigg::Models::V1::Plan::Data::DefaultTrialConfig, nil] Default trial configuration for the plan
          #
          #   @param description [String, nil] The description of the package
          #
          #   @param display_name [String] The display name of the package
          #
          #   @param entitlements [Array<Stigg::Models::V1::Plan::Data::Entitlement>] List of entitlements of the package
          #
          ...
          #
          #   @param pricing_type [Symbol, Stigg::Models::V1::Plan::Data::PricingType, nil] The pricing type of the package
          #
          #   @param product_id [String] The product id of the package
          #
          #   @param status [Symbol, Stigg::Models::V1::Plan::Data::Status] The status of the package
          #
          #   @param updated_at [Time] Timestamp of when the record was last updated
          #
          #   @param version_number [Integer] The version number of the package

          # @see Stigg::Models::V1::Plan::Data#default_trial_config
          class DefaultTrialConfig < Stigg::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Stigg::Models::V1::Plan::Data::DefaultTrialConfig::Units]
            required :units, enum: -> { Stigg::V1::Plan::Data::DefaultTrialConfig::Units }

            # @!attribute budget
            #   Budget configuration for the trial
            #
            #   @return [Stigg::Models::V1::Plan::Data::DefaultTrialConfig::Budget, nil]
            optional :budget, -> { Stigg::V1::Plan::Data::DefaultTrialConfig::Budget }, nil?: true

            # @!attribute trial_end_behavior
            #   Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)
            #
            #   @return [Symbol, Stigg::Models::V1::Plan::Data::DefaultTrialConfig::TrialEndBehavior, nil]
            optional :trial_end_behavior,
                     enum: -> { Stigg::V1::Plan::Data::DefaultTrialConfig::TrialEndBehavior },
            ...
            #
            #   @param units [Symbol, Stigg::Models::V1::Plan::Data::DefaultTrialConfig::Units] The time unit for the trial duration (DAY or MONTH)
            #
            #   @param budget [Stigg::Models::V1::Plan::Data::DefaultTrialConfig::Budget, nil] Budget configuration for the trial
            #
            #   @param trial_end_behavior [Symbol, Stigg::Models::V1::Plan::Data::DefaultTrialConfig::TrialEndBehavior, nil] Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)

            # The time unit for the trial duration (DAY or MONTH)
            #
            # @see Stigg::Models::V1::Plan::Data::DefaultTrialConfig#units
            module Units
            ...
            # @see Stigg::Models::V1::Plan::Data::DefaultTrialConfig#budget
            ...
            # Behavior when the trial ends (CONVERT_TO_PAID or CANCEL_SUBSCRIPTION)
            #
            # @see Stigg::Models::V1::Plan::Data::DefaultTrialConfig#trial_end_behavior
          ...
          class Entitlement < Stigg::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, Stigg::Models::V1::Plan::Data::Entitlement::Type]
            required :type, enum: -> { Stigg::V1::Plan::Data::Entitlement::Type }
            ...
            #   @param id [String] The unique identifier for the entity
            #
            #   @param type [Symbol, Stigg::Models::V1::Plan::Data::Entitlement::Type]

            # @see Stigg::Models::V1::Plan::Data::Entitlement#type
            module Type
              extend Stigg::Internal::Type::Enum
          ...
          # The pricing type of the package
          #
          # @see Stigg::Models::V1::Plan::Data#pricing_type
          module PricingType
            extend Stigg::Internal::Type::Enum
          ...
          # The status of the package
          #
          # @see Stigg::Models::V1::Plan::Data#status
          module Status
            extend Stigg::Internal::Type::Enum
