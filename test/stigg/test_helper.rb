...
class Stigg::Test::SingletonClient < Stigg::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Stigg::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Stigg::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @stigg = Stigg::Test::SingletonClient.instance
  end
