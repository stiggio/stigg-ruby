...
class Stigg::Test::PrimitiveModelTest < Minitest::Test
  A = Stigg::Internal::Type::ArrayOf[-> { Integer }]
  H = Stigg::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Stigg::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Stigg::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Stigg::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Stigg::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Stigg::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Stigg::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Stigg::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Stigg::Internal::Type::Boolean, true] => true,
      [Stigg::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Stigg::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Stigg::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Stigg::Internal::Type::Converter.new_coerce_state
      Stigg::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Stigg::Internal::Type::Converter.dump(target, input, state: state)
...
class Stigg::Test::EnumModelTest < Minitest::Test
  class E0
    include Stigg::Internal::Type::Enum
...
class Stigg::Test::CollectionModelTest < Minitest::Test
  A1 = Stigg::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Stigg::Internal::Type::HashOf[Integer]

  A2 = Stigg::Internal::Type::ArrayOf[H1]
  H2 = Stigg::Internal::Type::HashOf[-> { A1 }]

  A3 = Stigg::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Stigg::Internal::Type::HashOf[Integer, nil?: true]
...
class Stigg::Test::BaseModelTest < Minitest::Test
  class M1 < Stigg::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Stigg::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Stigg::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Stigg::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Stigg::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Stigg::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Stigg::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Stigg::Errors::ConversionError => e
...
class Stigg::Test::UnionTest < Minitest::Test
  class U0
    include Stigg::Internal::Type::Union
  ...
  class M2 < Stigg::Internal::Type::BaseModel
  ...
  class M4 < Stigg::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Stigg::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Stigg::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Stigg::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Stigg::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Stigg::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Stigg::Internal::Type::Unknown, Stigg::Internal::Type::Unknown] => true,
      [Stigg::Internal::Type::Boolean, Stigg::Internal::Type::Boolean] => true,
      [Stigg::Internal::Type::Unknown, Stigg::Internal::Type::Boolean] => false,
...
class Stigg::Test::MetaInfoTest < Minitest::Test
  A1 = Stigg::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Stigg::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
